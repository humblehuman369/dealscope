...
class LOIService:
    ...
    def _generate_text(
        ...
        lines.append("")
        lines.append("=" * 60)
        lines.append(f"Generated by InvestIQ | LOI-{loi_id} | {today}")
        lines.append("=" * 60)
...
<body>
    ...
    <div class="footer">
        Generated by InvestIQ | LOI-{loi_id} | {today}
    </div>
</body>
</html>
"""
    ...
    def _generate_pdf(
        ...
        story.append(Paragraph(
            f"<font size=9 color='#999999'>Generated by InvestIQ | LOI-{loi_id} | {today}</font>",
