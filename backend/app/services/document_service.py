...
class DocumentService:
    ...
    async def upload_document(
        ...
        # Create database record. ``filename`` and ``storage_key`` are NOT NULL;
        # ``filename`` holds the sanitized unique name generated by storage.upload.
        document = Document(
    ...
    async def download_document(
        ...
        return file_bytes, document.original_filename, document.file_type
    ...
    async def get_document_url(
        ...
        return await storage.get_url(document.storage_key, expires_in)
