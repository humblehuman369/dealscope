...
class CacheService:
    ...
    async def get_calculation(self, property_id: str, assumptions_hash: str) -> Optional[Dict]:
...
async def init_cache_service(redis_url: Optional[str] = None) -> CacheService:
