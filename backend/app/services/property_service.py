...
# Re-export from the new focused module so existing code continues to work.
# Source of truth lives in app/services/property/cache.py
...
class PropertyService:
    ...
    async def search_property(
        ...
        response = PropertyResponse(
            ...
            listing=ListingInfo(
                ...
                is_pre_foreclosure=normalized.get("is_pre_foreclosure") or False,
                ...
                owner_names=normalized.get("owner_names"),
                owner_type=normalized.get("owner_type"),
    ...
    def _build_seller_motivation(
        ...
        result = calculate_seller_motivation(
            ...
            is_pre_foreclosure=bool(normalized.get("is_pre_foreclosure")),
    ...
    def _build_valuations(self, normalized: dict) -> ValuationData:
        ...
        return ValuationData(
            ...
            realtor_estimate=normalized.get("realtor_estimate"),
