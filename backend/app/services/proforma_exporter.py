...
def get_price_label(is_off_market: bool = False, listing_status: str | None = None) -> str:
...
class ProformaExcelExporter:
    ...
    def __init__(self, proforma: FinancialProforma, is_off_market: bool = False, listing_status: str | None = None):
        self.data = proforma
        self.wb = Workbook()
    ...
    def _create_depreciation_tab(self):
        ...
        basis_rows = [
            ...
            ("  Land Value % (non-depreciable)", dep.land_value_percent, "percent"),
    ...
    def _create_exit_analysis_tab(self):
        ...
        tax_rows = [
            ...
            (
                f"  Tax on Capital Gain ({exit_data.capital_gains_tax_rate:.0%})",
                exit_data.capital_gains_tax,
                "currency",
            ),
        ]
    ...
    def _create_returns_summary_tab(self):
        ...
        return_rows = [
            ...
            (
                "Payback Period",
                f"{returns.payback_period_months or 'N/A'} months" if returns.payback_period_months else "N/A",
                "text",
            ),
        ]
    ...
    def _create_assumptions_tab(self):
        ...
        tax_rows = [
            ...
            (
                "Marginal Tax Rate",
                self.data.projections.annual_projections[0].marginal_tax_rate
                if self.data.projections.annual_projections
                else 0.24,
                "percent",
            ),
