...
class ReportService:
    ...
    def generate_excel_report(
        ...
        strategy_order = [active_strategy] + [
            s for s in ["ltr", "str", "brrrr", "flip", "house_hack", "wholesale"] if s != active_strategy
        ]
    ...
    def _create_executive_summary_sheet(
        self, wb: Workbook, property_data: dict, analytics: dict, assumptions: dict | None = None
    ):
        ...
        Font(bold=True, size=12, color=self.NAVY)
        ...
        overview_data = [
            ...
            (
                "Current Value (AVM)",
                f"${valuations.get('current_value_avm', 0):,.0f}" if valuations.get("current_value_avm") else "N/A",
            ),
        ]
    ...
    def _create_dscr_analysis_sheet(
        ...
        header_font = Font(bold=True, size=11, color="FFFFFF")
        header_fill = PatternFill(start_color=self.NAVY, end_color=self.NAVY, fill_type="solid")
        PatternFill(start_color=self.LIGHT_GRAY, end_color=self.LIGHT_GRAY, fill_type="solid")
    ...
    def _create_pro_forma_sheet(
        ...
        header_fill = PatternFill(start_color=self.NAVY, end_color=self.NAVY, fill_type="solid")
        PatternFill(start_color=self.BRAND_BLUE, end_color=self.BRAND_BLUE, fill_type="solid")
    ...
    def _create_sensitivity_sheet(
        ...
        ltr.get("cash_on_cash_return", 0.08)
    ...
    def _create_summary_sheet(self, wb: Workbook, property_data: dict, analytics: dict, active_strategy: str = "ltr"):
        ...
        row = 22
        for name, key, metric_key, _metric_label in strategies:
    ...
    def _create_ltr_sheet(self, wb: Workbook, property_data: dict, ltr_data: dict | None):
    ...
    def _create_str_sheet(self, wb: Workbook, property_data: dict, str_data: dict | None):
    ...
    def _create_brrrr_sheet(self, wb: Workbook, property_data: dict, brrrr_data: dict | None):
    ...
    def _create_flip_sheet(self, wb: Workbook, property_data: dict, flip_data: dict | None):
    ...
    def _create_house_hack_sheet(self, wb: Workbook, property_data: dict, hh_data: dict | None):
        ...
        self._create_strategy_sheet(
            ws,
            "House Hack",
            self.STRATEGY_COLORS["house_hack"],
            hh_data,
            [
    ...
    def _create_wholesale_sheet(self, wb: Workbook, property_data: dict, ws_data: dict | None):
        ...
        self._create_strategy_sheet(
            ws,
            "Wholesale",
            self.STRATEGY_COLORS["wholesale"],
            ws_data,
            [
                ("After Repair Value (ARV)", "arv", "currency"),
                ("Max Allowable Offer", "max_allowable_offer", "currency"),
    ...
    def _create_strategy_sheet(self, ws, title: str, color: str, data: dict, metrics: list[tuple]):
