"""
InvestIQ Property Investment Report — PDF Generator
...
{self._page_sensitivity()}
    ...
    def _page_header(self, title: str) -> str:
        ...
        return (
            ...
            f'<div class="logo">Invest<span class="logo-iq">IQ</span></div>'
    ...
    def _page_footer(self) -> str:
        return (
            ...
            f'<div class="footer-brand">Generated by InvestIQ</div>'
...
<div class="page">
  ...
  {self._section_header("INVESTIQ VERDICT", "Deal Score & Verdict")}
...
<div class="page">
  ...
  <div class="final-footer">
    <div class="logo" style="font-size:18px;">Invest<span class="logo-iq">IQ</span></div>
