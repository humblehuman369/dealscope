...
class UserService:
    ...
    async def get_user_by_id(self, db: AsyncSession, user_id: str, include_profile: bool = True) -> User | None:
    ...
    async def create_profile(self, db: AsyncSession, user_id: str, data: UserProfileCreate) -> UserProfile:
    ...
    async def update_profile(self, db: AsyncSession, profile: UserProfile, data: UserProfileUpdate) -> UserProfile:
    ...
    async def update_onboarding(
        self, db: AsyncSession, profile: UserProfile, step: int, completed: bool = False
    ) -> UserProfile:
