# InvestIQ Mobile — App Store Launch Checklist
...
### Copy
- [ ] App name: "InvestIQ" (30 chars max iOS, 50 chars max Android)
...
### Legal
- [ ] Privacy policy URL: `https://realvestiq.com/privacy` (already configured)
- [ ] Terms of service URL: `https://realvestiq.com/terms`
- [ ] Support URL: `https://realvestiq.com/help` or `mailto:support@realvestiq.com`
...
- [ ] Restrict Google Maps API key in Google Cloud Console:
  - iOS: bundle ID `com.investiq.mobile`
  - Android: package `com.investiq.mobile` + SHA-1 fingerprint
