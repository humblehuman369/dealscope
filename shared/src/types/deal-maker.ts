/**
 * Deal Maker Types — Single Source of Truth
 *
...
export type DealMakerRecordUpdate = Partial<
  Omit<DealMakerRecord, 'list_price' | 'rent_estimate' | 'initial_assumptions' | 'cached_metrics' | 'created_at' | 'updated_at' | 'version'>
>;

// =============================================================================
// DEAL MAKER RESPONSE (from backend)
// =============================================================================
