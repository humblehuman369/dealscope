 ...
 * - Light-themed icon navigation bar with 5 custom icons
 *
...
const VerdictIQIcon = ({ active: _active }: { active?: boolean }) => (
  <svg viewBox="0 0 147.76 147.76" className="w-5 h-5">
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M18.39,18.39c21.41-21.38,56.1-21.38,77.48,0,21.41,21.41,21.41,56.1,0,77.51-21.38,21.41-56.07,21.41-77.48,0C-3.02,74.49-3.02,39.8,18.39,18.39h0ZM24.57,24.57c17.99-17.96,47.17-17.96,65.13,0,17.99,17.99,17.99,47.17,0,65.16-17.96,17.99-47.14,17.99-65.13,0-17.99-17.99-17.99-47.17,0-65.16h0Z"
    />
    <path
      fill="currentColor"
      d="M16.73,16.76C27.89,5.61,42.52,0,57.13,0s29.25,5.61,40.4,16.76,16.76,25.76,16.76,40.4-5.61,29.25-16.76,40.4-25.76,16.73-40.4,16.73-29.24-5.58-40.4-16.73C5.58,86.41,0,71.77,0,57.16S5.58,27.92,16.73,16.76h0ZM57.13,4.71c-13.41,0-26.86,5.11-37.08,15.34-10.26,10.26-15.37,23.67-15.37,37.11s5.11,26.82,15.37,37.08c10.22,10.26,23.67,15.37,37.08,15.37s26.86-5.11,37.11-15.37c10.22-10.26,15.34-23.67,15.34-37.08s-5.11-26.86-15.34-37.11c-10.26-10.22-23.67-15.34-37.11-15.34h0ZM22.9,22.94c9.46-9.46,21.84-14.17,34.23-14.17s24.8,4.71,34.23,14.17c9.46,9.43,14.17,21.84,14.17,34.22s-4.71,24.76-14.17,34.23c-9.43,9.43-21.84,14.17-34.23,14.17s-24.76-4.75-34.23-14.17c-9.46-9.46-14.17-21.84-14.17-34.23s4.71-24.8,14.17-34.22h0ZM57.13,13.44c-11.19,0-22.37,4.25-30.91,12.78-8.53,8.56-12.81,19.75-12.81,30.94s4.28,22.37,12.81,30.91c8.53,8.53,19.72,12.81,30.91,12.81s22.37-4.28,30.94-12.81c8.53-8.53,12.78-19.72,12.78-30.91s-4.25-22.37-12.78-30.94c-8.56-8.53-19.75-12.78-30.94-12.78h0Z"
    />
    <polygon
      fill="currentColor"
      fillRule="evenodd"
      points="80.4 52.65 80.4 83.92 65.2 83.92 65.2 62.87 49.06 62.87 49.06 83.92 33.86 83.92 33.86 52.62 29.35 56.43 24.7 50.99 57.13 23.57 68.88 33.49 68.88 27.22 80.4 27.22 80.4 43.25 89.56 50.99 84.92 56.43 80.4 52.65"
    />
    <path
      fill="currentColor"
    ...
    <path
      fill="currentColor"
      d="M103.34,87.41l12.28,12.28c.93.93.93,2.42,0,3.32l-12.61,12.65c-.93.9-2.42.9-3.32,0l-12.28-12.31c-.93-.9-.93-2.39,0-3.29.13-.13.3-.27.43-.36,1.1-.8,2.19-1.63,3.25-2.52,1.03-.9,2.09-1.86,3.15-2.92,1.03-1.06,1.99-2.09,2.89-3.15.96-1.13,1.86-2.26,2.66-3.39.76-1.03,2.22-1.29,3.25-.53.1.07.2.17.3.23h0Z"
    />
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M113.96,101.35c2.32.33,4.55,1.39,6.34,3.15l21.84,21.84c4.35,4.35,4.35,11.45,0,15.8h0c-4.35,4.35-11.45,4.35-15.8,0l-21.84-21.84c-1.79-1.76-2.82-4.02-3.15-6.31l12.61-12.65Z"
    />
  </svg>
)
...
const SoldCompsIcon = ({ active: _active }: { active?: boolean }) => (
  <svg viewBox="0 0 151.46 141.28" className="w-5 h-5">
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M128.4,68.08v70.84H23.07v-70.84l-10.22,8.6-10.49-12.32L75.75,2.32l26.52,22.44v-14.21h26.13v36.28l20.75,17.53-10.52,12.32-10.22-8.6ZM75.75,45.54c22.01,0,39.87,17.89,39.87,39.9s-17.86,39.9-39.87,39.9-39.9-17.86-39.9-39.9,17.86-39.9,39.9-39.9h0Z"
    />
    <path
      fill="currentColor"
      d="M75.75,43.22c11.65,0,22.21,4.71,29.84,12.38,7.67,7.63,12.38,18.19,12.38,29.84s-4.71,22.24-12.38,29.88c-7.63,7.64-18.19,12.38-29.84,12.38s-22.24-4.75-29.88-12.38c-7.64-7.63-12.38-18.19-12.38-29.88s4.75-22.21,12.38-29.84c7.64-7.67,18.19-12.38,29.88-12.38h0Z"
    />
    <path
      fill="currentColor"
      d="M92.21,72.56c0,1.29-1.06,2.36-2.36,2.36s-2.32-1.06-2.32-2.36c0-2.36-1.26-4.25-3.09-5.58-2.49-1.89-5.97-2.82-8.96-2.82-3.72,0-6.67.96-8.7,2.59-1.96,1.56-3.02,3.78-3.02,6.37,0,5.05,5.88,7.4,11.58,9.66.13.07,1.26.5,1.26.5l1.23.5c7.17,2.86,14.54,5.78,14.54,13.98,0,4.08-1.69,7.57-4.75,10.02-2.85,2.29-6.84,3.62-11.65,3.62-3.88,0-8.43-1.23-11.75-3.72-2.95-2.19-4.98-5.31-4.98-9.36,0-1.29,1.06-2.32,2.36-2.32s2.36,1.03,2.36,2.32c0,2.39,1.23,4.25,3.05,5.61,2.49,1.86,5.98,2.79,8.96,2.79,3.72,0,6.67-.96,8.7-2.59,1.96-1.53,3.02-3.75,3.02-6.37,0-5.05-5.88-7.37-11.59-9.66-.83-.3-.2-.07-1.26-.47l-1.19-.5c-7.2-2.85-14.57-5.81-14.57-14.01,0-4.05,1.69-7.54,4.75-9.99,2.85-2.29,6.84-3.65,11.65-3.65,3.88,0,8.43,1.26,11.78,3.75,2.92,2.16,4.95,5.28,4.95,9.33h0Z"
    />
    <path
      fill="currentColor"
      d="M78.07,112.8c0,1.29-1.03,2.36-2.32,2.36s-2.36-1.06-2.36-2.36v-54.67c0-1.29,1.06-2.36,2.36-2.36s2.32,1.06,2.32,2.36v54.67Z"
    />
  </svg>
)
...
const DealsMakerIcon = ({ active: _active }: { active?: boolean }) => (
  <svg viewBox="0 0 92.92 92.92" className="w-5 h-5">
    ...
    <path
      fill="#FFFFFF"
      d="M46.46,85.68c-21.63,0-39.22-17.59-39.22-39.22S24.83,7.24,46.46,7.24s39.22,17.59,39.22,39.22-17.59,39.22-39.22,39.22ZM46.46,10.29c-19.94,0-36.17,16.22-36.17,36.17s16.22,36.17,36.17,36.17,36.17-16.22,36.17-36.17S66.4,10.29,46.46,10.29Z"
    />
    <path
      fill="#FFFFFF"
      d="M44.75,74.6v-6.7l-.81-.1c-3.15-.37-7.57-1.73-10.86-4.42l3.4-5.27c3.43,2.48,6.38,3.59,9.45,3.59,5.34,0,6.46-3.05,6.46-5.61,0-3.57-3.7-5.45-7.61-7.44-4.85-2.47-10.34-5.26-10.34-11.69s3.49-10.43,9.56-11.64l.74-.15v-6.87h4.8v6.77l.78.12c3.42.52,6.29,2.01,8.98,4.66l-3.84,4.4c-2.17-1.85-4.33-3.05-7.32-3.05-4.93,0-5.96,2.88-5.96,5.29,0,3.26,3.5,4.94,7.2,6.71,5.04,2.42,10.75,5.16,10.75,12.2,0,6.36-3.59,10.76-9.85,12.09l-.73.15v6.95h-4.8Z"
    />
  </svg>
)
  ...
  return (
    <header className="font-sans">
      ...
      <div className="max-w-[480px] mx-auto bg-[var(--surface-card)] relative shadow-[var(--shadow-card)]">
        ...
        >
          <span className="text-sm text-[var(--text-heading)] font-semibold truncate">
            {fullAddress}
          </span>
          <svg
          ...
          <div className="flex gap-3 items-stretch">
            {property.image && !propertyImageFailed ? (
              ...
              <div className="w-[80px] h-[60px] rounded-lg flex-shrink-0 bg-[var(--surface-elevated)] flex items-center justify-center shadow-sm">
                <svg
                  className="w-6 h-6 text-[var(--text-label)]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="flex-1 grid grid-cols-3 gap-1.5 min-w-0">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-[var(--text-label)] uppercase tracking-wide mt-0.5 font-medium">
                  Beds
                </span>
              </div>
              <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-[var(--accent-sky)]">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-[var(--accent-sky)]">
                  {formatPrice(property.rent || 5555)}
                </span>
                <span className="text-[10px] text-[var(--text-label)] uppercase tracking-wide mt-0.5 font-medium">
                  Est. Rent
                </span>
        ...
        <nav className="bg-gradient-to-b from-[var(--surface-elevated)] to-[var(--surface-section)] px-3 py-2 flex items-center justify-around border-t-2 border-[var(--border-subtle)]">
          {NAV_ITEMS.map((item) => {
            ...
            const tooltipText = isDisabled ? `${item.label} (No property selected)` : item.label
