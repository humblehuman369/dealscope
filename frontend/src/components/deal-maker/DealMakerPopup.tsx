...
export function DealMakerPopup({
  ...
  const authParams = new URLSearchParams(searchParams.toString())
        ...
        <div className="w-full max-w-lg bg-[var(--surface-base)] rounded-t-2xl p-8 text-center">
          ...
          <div className="flex gap-3 justify-center">
            <Link
              ...
              style={{ background: 'linear-gradient(135deg, #0FA4E9, #0284C7)' }}
            >
              Sign in
            </Link>
            <button
  ...
  return (
    ...
    >
      ...
      >
              ...
              <button
                ...
                className={`px-3 py-1.5 text-[11px] font-semibold rounded-full transition-all ${
                  activePriceTarget === target
                    ? 'bg-[#0FA4E9] text-white shadow-sm'
                    : 'bg-white/[0.05] text-[#94A3B8] hover:bg-white/[0.1]'
                }`}
              >
                {labels[target]}
        ...
        {/* Instructions */}
        <div className="flex items-start gap-2.5 px-5 py-3.5 bg-[#0FA4E9]/[0.06] border-b border-white/[0.07] flex-shrink-0">
          <div className="w-7 h-7 bg-white/[0.06] rounded-lg flex items-center justify-center flex-shrink-0">
            <Info className="w-4 h-4 text-[#0FA4E9]" />
          </div>
          <p className="text-[13px] text-[#0FA4E9] leading-relaxed">
        ...
        <div className="flex gap-3 px-5 py-4 border-t border-white/[0.07] bg-[var(--surface-base)] flex-shrink-0">
          ...
          <button 
            onClick={handleApply}
            className="flex-1 flex items-center justify-center gap-2 py-3.5 px-5 bg-[#0FA4E9] rounded-xl text-white text-[15px] font-semibold hover:bg-[#0284c7] active:scale-[0.98] transition-all"
          >
            Apply Changes
