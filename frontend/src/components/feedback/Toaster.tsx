    ...
    <SonnerToaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          actionButton:
            'bg-[var(--accent-sky)] text-[var(--text-inverse)] hover:bg-[var(--accent-sky-light)]',
          cancelButton:
            'bg-[var(--surface-elevated)] text-[var(--text-body)] hover:bg-[var(--surface-card-hover)]',
          closeButton:
            'bg-[var(--surface-elevated)] text-[var(--text-label)] hover:text-[var(--text-heading)]',
