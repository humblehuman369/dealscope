  ...
  return (
    <div 
      className={`
        ...
        ${isCollapsed 
          ? 'p-3 bg-transparent border-brand-500/10 dark:border-[#0FA4E9]/10' 
          : 'p-6 bg-gradient-to-br from-brand-500/8 to-blue-500/4 dark:from-[#0FA4E9]/8 dark:to-[#0465f2]/4 border-brand-500/20 dark:border-[#0FA4E9]/20'
        }
      `}
      onClick={onToggle}
    >
      ...
      {!isCollapsed && (
        <>
          <h3 className="text-lg font-bold text-brand-500 dark:text-[#0FA4E9] mb-4">
      ...
      {isCollapsed && (
        <p className="text-center text-sm text-gray-600 dark:text-white/60">
          ...
          <span className="text-brand-500 dark:text-[#0FA4E9] font-semibold">
