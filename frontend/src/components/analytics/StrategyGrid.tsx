...
import { Home, Palmtree, RefreshCw, Hammer, Users, FileSignature, TrendingUp } from 'lucide-react'
    ...
    <div className="strategy-grid-premium">
      {STRATEGIES.map((strategy) => {
        ...
        return (
          ...
          >
            {/* Number Badge */}
            <div className="strategy-number-premium">{strategy.number}</div>
...
export function StrategyPrompt() {
  return (
    <div className="strategy-prompt-premium">
      ...
      {/* Title */}
      <h2 className="strategy-title-main">One Property, Multiple Opportunities</h2>

      {/* Subtitle */}
      <p className="strategy-subtitle-main">
        IQ analyzed your property and built 6 investment strategies, each showing a different way to
        profit.
      </p>
    </div>
  )
