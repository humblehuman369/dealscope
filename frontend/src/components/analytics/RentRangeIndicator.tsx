...
export function RentRangeIndicator({
  ...
  if (compact) {
    return (
      <div className={`inline-flex items-center gap-2 ${className}`}>
        ...
        {stats.rentTrend && (
          <span
            className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-xs font-medium ${config.bgColor} ${config.textColor}`}
          >
  ...
  return (
    <div
      className={`rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden bg-white dark:bg-gray-900 ${className}`}
    >
      {/* Header */}
      ...
      <div className="p-4">
        ...
        <div className="text-center mb-4">
          <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">RentCast Estimate</div>
...
export function RentEstimateBadge({
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 ${className}`}>
      ...
      {stats.rentTrend && <TrendIcon className={`w-3.5 h-3.5 ${trendColor}`} />}
    </span>
  )
}
