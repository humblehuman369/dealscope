...
export function ProfitQualityCard({ data, isDark = false }: ProfitQualityCardProps) {
  ...
  return (
    <div className={`rounded-xl p-4 mb-3 ${isDark ? 'bg-[#0F1D32]' : 'bg-white'}`}>
      {/* Header */}
      <h3 className="text-[11px] font-bold tracking-wide text-[#0FA4E9] mb-4">
        PROFIT QUALITY
      </h3>
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <button 
          className="flex items-center gap-1 py-1 text-[#0FA4E9] hover:opacity-80 transition-opacity"
      ...
      {/* Insight */}
      <div className="mt-4 pl-3 border-l-[3px] border-[#0FA4E9]">
