...
export function PerformanceBenchmarks({
  ...
  return (
    <div className="bg-white dark:bg-white/[0.02] border-2 border-[#0FA4E9] dark:border-[#0FA4E9] rounded-2xl px-2 py-3 mb-4">
      {/* Header */}
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      {benchmarks.slice(0, 4).map((benchmark) => (
        <div 
          key={benchmark.id}
          className="bg-white dark:bg-white/[0.02] border-2 border-[#0FA4E9] dark:border-[#0FA4E9] rounded-xl p-3"
        >
