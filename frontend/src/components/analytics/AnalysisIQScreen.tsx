...
import {
  CompactHeader,
  type PropertyData as HeaderPropertyData,
...
function getRangePosition(
  metric: string,
  value: number,
): { position: number; segment: 'low' | 'avg' | 'high' } {
  ...
  return (
    <div className="mb-5 last:mb-0">
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <span className="text-base font-bold text-[var(--text-heading)] tabular-nums">
          {displayValue}
        </span>
      </div>
      ...
      <div className="bg-[var(--surface-section)] rounded-xl p-3 px-4 border border-[var(--border-subtle)]">
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to right, var(--text-label) 0%, var(--text-secondary) 20%, var(--text-body) 40%, var(--accent-brand-blue) 60%, var(--accent-sky) 75%, var(--accent-sky) 90%, var(--accent-sky-light) 100%)',
        ...
        <div className="flex justify-between mt-2">
          <div className="text-left">
            <div className="text-[9px] font-bold text-[var(--text-secondary)] uppercase tracking-wide">
              Low
            </div>
            <div className="text-[10px] text-[var(--text-label)] mt-0.5">
...
export function AnalysisIQScreen({
  property,
  initialStrategy,
  savedPropertyId,
}: AnalysisIQScreenProps) {
  ...
  const metrics = useMemo(() => {
    ...
    const noi =
      annualRent - effectiveProperty.propertyTaxes - effectiveProperty.insurance - annualRent * 0.05 // 5% vacancy
    ...
    // Expense Ratio
    const totalExpenses =
      effectiveProperty.propertyTaxes + effectiveProperty.insurance + annualRent * 0.05
    ...
    // Breakeven Occupancy
    const fixedCosts =
      effectiveProperty.propertyTaxes + effectiveProperty.insurance + annualDebtService
    ...
    <div className="min-h-screen bg-[var(--surface-section)] max-w-[480px] mx-auto font-['Inter',sans-serif]">
      ...
      <main>
        ...
        <section className="bg-[var(--surface-card)] p-5 border-b border-[var(--border-default)]">
          <div className="text-[11px] font-bold text-[var(--accent-sky)] uppercase tracking-[0.08em] mb-4">
            Profit Rating
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            >
              <div className="w-[70px] h-[70px] rounded-full bg-[var(--surface-card)] flex flex-col items-center justify-center">
                <span className="text-[28px] font-extrabold text-[var(--text-heading)] leading-none">
                  {score}
                </span>
            ...
            <div className="flex-1">
              <div className="flex justify-between py-1.5">
                ...
                <span className="text-sm font-semibold text-[var(--status-positive)]">
                  {strategyFit}
                </span>
              </div>
              <div className="flex justify-between py-1.5">
              ...
              <div className="flex justify-between py-1.5">
                ...
                <span
                  className={`text-sm font-semibold ${protection === 'Weak' ? 'text-[var(--status-negative)]' : 'text-[var(--status-positive)]'}`}
                >
                  {protection}
                </span>
              </div>
          ...
          {showFactors && (
            <div className="mt-3 pt-3 border-t border-[var(--border-subtle)] grid grid-cols-2 gap-3">
              <div>
                <p className="text-[10px] text-[var(--text-label)] uppercase tracking-wider mb-1">
                  Return Profile
                </p>
              ...
              <div>
                ...
                <p
                  className={`text-sm font-semibold ${score < 50 ? 'text-[var(--status-negative)]' : 'text-[var(--text-heading)]'}`}
                >
        ...
        <div className="p-4 px-5 bg-[var(--surface-card)] border-b border-[var(--border-default)] flex items-start gap-3">
          ...
          <p className="text-sm text-[var(--text-body)] leading-relaxed">
            {score >= 70 ? (
              <>
                This deal shows{' '}
                <strong className="text-[var(--accent-sky)] font-semibold">
                  strong fundamentals
                </strong>{' '}
              ...
              <>
                This deal has potential but requires careful consideration.{' '}
                <strong className="text-[var(--accent-sky)] font-semibold">
              ...
              <>
                This deal shows{' '}
                <strong className="text-[var(--status-negative)] font-semibold">
                  weak metrics
                </strong>
          ...
          >
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, var(--surface-base) 0%, var(--surface-elevated) 100%)',
                }}
              >
                <svg
                  width="20"
              ...
              <span className="text-[15px] font-semibold text-[var(--text-heading)]">
                Return Metrics
              </span>
            </div>
            <svg
            ...
            <div className="px-5 pb-5">
              {performanceBars.map((bar, idx) => (
                <div key={idx} className="flex items-center mb-3 last:mb-0">
                  ...
                  <span className="text-sm font-bold text-[var(--text-heading)] tabular-nums min-w-[45px] text-right">
              ...
              <div className="mt-4 pt-4 border-t border-[var(--border-subtle)]">
                <p className="text-[13px] text-[var(--text-secondary)]">
                  <span className="font-semibold text-[var(--text-heading)]">Composite:</span>{' '}
