...
import type {
  ...
  SellerMotivationIndicator as IndicatorType,
} from '../property-details/types'
...
export function SellerMotivationIndicator({
  ...
  if (compact) {
    return (
      <div
        className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${getGradeBgColor(motivation.grade)} ${className}`}
      >
            ...
            return (
              <div
                ...
                className={`flex items-center gap-3 p-2 rounded-lg ${
                  isHighSignal ? 'bg-green-50 dark:bg-green-900/20' : 'bg-gray-50 dark:bg-gray-800'
                }`}
              >
                <div
                  className={`p-1.5 rounded-full ${
                    isHighSignal ? 'bg-green-100 dark:bg-green-800' : 'bg-gray-200 dark:bg-gray-700'
                  }`}
                >
                  <Icon
                    className={`w-4 h-4 ${
...
export function SellerMotivationBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium ${getBgColor(motivation.score)} ${className}`}
    >
