    ...
    <div className={`flex flex-col gap-3 ${className}`}>
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 shadow-lg overflow-hidden">
        ...
        <div className="px-3 py-2.5 flex items-start justify-between gap-2.5 border-b border-slate-100 dark:border-white/5 bg-gradient-to-b from-slate-50 dark:from-black/20 to-transparent">
          <div>
            <h2 className="text-xs font-black tracking-wider uppercase text-slate-700 dark:text-white">
              Decision Chart
            </h2>
          ...
          <span className={`text-[10px] px-2 py-1 rounded-full border font-bold tracking-wide ${getZoneBadgeStyles(decisionHeadline as DealZoneLabel)}`}>
            {decisionHeadline}
          </span>
        </div>
        ...
        <div className="p-3">
          ...
          <div className="mt-3 p-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 flex items-center justify-between gap-3">
            <div className="flex flex-col gap-0.5">
              <div className="text-[10px] font-black tracking-wider uppercase text-slate-500 dark:text-white/60">
                Deal Gap
              </div>
              <div className="text-[11px] font-semibold text-slate-500 dark:text-white/50 whitespace-nowrap overflow-hidden text-ellipsis">
          ...
          {/* Footer text */}
          <p className="mt-2.5 text-[11px] text-slate-500 dark:text-white/60 leading-relaxed">
            Buy is{' '}
      ...
      {showSlider && (
        <div className="flex items-center justify-between gap-2.5 p-3 rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 shadow-lg">
          <div>
            <label htmlFor="buyPosSlider" className="text-[11px] font-black tracking-wider uppercase text-slate-500 dark:text-white/60">
              Buy Price Position
            </label>
