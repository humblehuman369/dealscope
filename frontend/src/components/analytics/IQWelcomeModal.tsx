...
export function IQWelcomeModal({ isOpen, onClose }: IQWelcomeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      {/* Modal */}
      <div className="relative bg-gradient-to-br from-[#0d1f35] to-[#091525] border border-[#0FA4E9]/30 rounded-2xl p-8 max-w-md w-full shadow-2xl shadow-[#0FA4E9]/10">
        {/* IQ Brain Icon */}
        <div className="flex justify-start mb-6">
          <div className="w-12 h-12 rounded-full bg-[#0FA4E9]/10 flex items-center justify-center">
        ...
        <div className="flex justify-end mt-6">
          <button
            onClick={onClose}
            className="px-8 py-2.5 bg-[#0FA4E9] hover:bg-[#5dd8e8] text-[#07172e] font-bold rounded-lg transition-colors"
          >
            OK
          </button>
        </div>
