...
export function LTRSectionCard({
  ...
  return (
    <div
      className={`bg-white dark:bg-surface-800 rounded-xl shadow-card overflow-hidden transition-shadow hover:shadow-card-hover scroll-mt-[72px] ${
        expanded
          ? 'ring-2 ring-teal-600/20 dark:ring-teal-400/20'
