...
const getGradeStyles = (grade: string) => {
  switch(grade) {
    case 'A': return { bg: '#E0F7FA', text: '#0FA4E9' }
...
export function LTRWorksheet({ 
  ...
  const scoreColor = profitQualityScore >= 70 ? '#0FA4E9' : profitQualityScore >= 40 ? '#F59E0B' : '#E11D48'
  ...
  const dealRatingColor = profitQualityScore >= 60 ? '#0FA4E9' : profitQualityScore >= 40 ? '#D97706' : '#E11D48'
        ...
        <div style={{ position: 'relative' }}>
          <button 
            ...
            style={{
              ...
              padding: '12px 16px',
              backgroundColor: showStrategyDropdown ? '#0FA4E9' : 'rgba(255,255,255,0.1)',
              ...
              {strategies.map((strategy, idx) => (
                ...
                >
                  <span style={{
                    ...
                    color: selectedStrategy === strategy ? '#0FA4E9' : '#0A1628'
                  }}>
                    {strategy}
                  </span>
                  {selectedStrategy === strategy && (
                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#0FA4E9" strokeWidth={2}>
      ...
      <main style={{ padding: '16px', maxWidth: '480px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ width: '3px', backgroundColor: '#0FA4E9', borderRadius: '2px', flexShrink: 0 }} />
            <p style={{ fontSize: '14px', color: '#475569', margin: 0, lineHeight: 1.5 }}>
              {getSummaryText(profitQualityScore)}{' '}
              {profitQualityScore < 70 && (
                <span style={{ color: '#0FA4E9', fontWeight: 500 }}>Value-add improvements</span>
              )}
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              <div style={{ 
                ...
                <svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="#0FA4E9" strokeWidth={1.5}>
