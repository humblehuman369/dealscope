...
export function FilterPanel({
  ...
  if (!isOpen) {
    return (
      <button
        onClick={onToggle}
        className="absolute top-20 left-4 z-10 flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium shadow-lg transition-colors"
        style={{
  ...
  return (
    <div
      className="absolute top-20 left-4 z-10 w-72 rounded-xl shadow-xl overflow-hidden"
      style={{
        backgroundColor: 'var(--surface-card)',
        border: '1px solid var(--border-default)',
      }}
