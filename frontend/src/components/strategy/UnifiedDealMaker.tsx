...
function DisplayRow({ label, value, color }: { label: string; value: string; color?: string }) {
  return (
    <div
      className="flex justify-between items-center py-2 pl-4 pr-1"
    ...
    >
      ...
      <span
        className="text-sm font-semibold tabular-nums text-right min-w-[100px]"
...
function TotalRow({ label, value }: { label: string; value: string }) {
  return (
    ...
    >
      ...
      <span
        className="font-bold tabular-nums text-[0.95rem] text-right min-w-[100px]"
  ...
  return (
    <div className="py-1 pl-4 pr-1" style={{ borderBottom: `1px solid ${C.border}` }}>
      <div style={{ ['--dealmaker-accent' as string]: C.blue }}>
        <DealMakerSlider config={mergedConfig} value={value} onChange={onChange} />
      </div>
      {suffix && (
        <div className="flex justify-end -mt-1 mb-1">
          <span className="text-xs tabular-nums" style={{ color: C.body }}>
            {suffix}
          </span>
        </div>
      )}
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div>
        ...
        <SliderRow
          config={{
            ...
            format: 'currency',
            helpText:
              'Principal the seller carries as a second mortgage or installment note. Range is 0% to 100% of buy price.',
          }}
        ...
        <SliderRow
          config={{
            ...
            format: 'percentage',
            helpText:
              'Fees paid at closing — title insurance, appraisal, attorney, etc. Often 0–5% of the purchase price depending on deal structure.',
          }}
      ...
      <div>
        ...
        <DisplayRow
          label="Combined Monthly Payment (est.)"
          value={`${formatCurrency(combinedPiEst)}/mo`}
        />
      ...
      <div>
        ...
        <SliderRow
          config={{
            ...
            format: 'percentage',
            helpText:
              'Percentage of rent set aside for ongoing maintenance and repairs. 5% is a common estimate.',
          }}
          value={maintPct}
          onChange={() => {}}
        ...
        <DisplayRow
          ...
          value={
            annualCashFlow >= 0
              ...
              : `(${formatCurrency(Math.abs(annualCashFlow))})`
          }
          color={annualCashFlow >= 0 ? C.positive : C.negative}
        />
        <DisplayRow label="Cap Rate" value={capRate !== null ? `${capRate.toFixed(2)}%` : '—'} />
        <DisplayRow
          label="Cash-on-Cash"
