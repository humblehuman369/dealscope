          ...
          <div className="flex flex-col flex-1 min-h-0 sm:flex-none">
                ...
                <div className="sm:hidden flex flex-col items-center shrink-0 mt-1">
                  <div className="relative w-[146px] h-[146px] flex items-center justify-center">
                    <div
                      ...
                      style={{
                        background:
                          'radial-gradient(circle, rgba(15,164,233,0.22) 0%, transparent 70%)',
                        filter: 'blur(8px)',
                      }}
                      aria-hidden
                    />
              ...
              <div className="sm:hidden flex flex-col items-center text-center mt-1 mb-4">
                <div className="relative w-20 h-20 flex items-center justify-center mb-3">
                  <div
                    ...
                    style={{
                      background:
                        'radial-gradient(circle, rgba(15,164,233,0.18) 0%, transparent 70%)',
                      filter: 'blur(6px)',
                    }}
                    aria-hidden
                  />
            ...
            {!showAddressInput ? (
                ...
                <div className="space-y-4 sm:space-y-4 w-full shrink-0">
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <h3
                        className="text-lg sm:text-base font-bold mb-1"
                        style={{ color: 'var(--text-heading)' }}
                      >
                        Scan Property
                      </h3>
                      <p
                        className="text-sm leading-relaxed sm:leading-snug"
              ...
              <form
                ...
                className="space-y-5 flex flex-col flex-1 min-h-0 sm:flex-none"
              >
