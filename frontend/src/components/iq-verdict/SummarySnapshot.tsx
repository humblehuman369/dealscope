    ...
    <div className="bg-white px-6 pb-4 border-l-[3px] border-l-[#0891B2] border-b border-[#E2E8F0] ml-4">
      ...
      <div className="mt-3 grid grid-cols-3 gap-3">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-[9px] text-[#94A3B8] uppercase">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-[9px] text-[#94A3B8] uppercase">Annual NOI</div>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-[9px] text-[#94A3B8] uppercase">Cash Needed</div>
        </div>
      </div>
    </div>
  )
