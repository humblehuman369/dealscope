        ...
        <div className="space-y-1">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              {sellerMotivation && (
                <span
                  className={`text-xs px-1.5 py-0.5 rounded ${getMotivationBg(motivationScore)} ${getMotivationColor(motivationScore)}`}
                >
                  {motivationScore}
                </span>
              )}
              ...
              {sellerMotivation.suggested_discount_range && (
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-semibold text-teal-600 dark:text-teal-400">
                    {sellerMotivation.suggested_discount_range.min}% -{' '}
                    {sellerMotivation.suggested_discount_range.max}%
                  </span>
                </div>
              )}
