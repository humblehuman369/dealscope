...
function StatusText({ status }: { status: string }) {
  ...
  return (
    <span
      className="text-[14px] sm:text-[19px] lg:text-[17px]"
      style={{
...
function DetailItem({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'baseline', gap: 5 }}>
      {label ? (
        <span
          className="text-[12px] sm:text-[16px] lg:text-[14px]"
          style={{
            fontFamily: "'Space Mono', monospace",
            textTransform: 'uppercase',
      ...
      <span
        className="text-[15px] sm:text-[19px] lg:text-[17px]"
        style={{
      ...
      >
        ...
        >
          ...
          <Link
            ...
            className="text-[16px] sm:text-[20px] lg:text-[18px] hover:underline"
          >
            {fullAddress}
          </Link>
        </div>
