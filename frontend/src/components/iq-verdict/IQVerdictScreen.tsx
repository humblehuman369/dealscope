        ...
        >
          <div className="flex gap-3">
            ...
            <div 
              ...
              style={{ background: COLORS.surface200 }}
            >
              {property.imageUrl ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <svg className="w-6 h-6" fill="none" stroke={COLORS.surface400} strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            <div className="text-right flex-shrink-0">
              <div 
                className="inline-block text-[9px] font-bold tracking-wide px-2 py-1 rounded mb-1"
                style={{ 
