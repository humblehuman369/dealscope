    ...
    <section className="mx-auto max-w-7xl px-6 pb-14 pt-12 md:pt-16">
      <div className="grid items-center gap-12 lg:grid-cols-12">
        ...
        <div className="relative lg:col-span-5">
          <div className="relative overflow-hidden rounded-3xl border border-[var(--border-default)] shadow-[var(--shadow-card)]">
            <Image
            ...
            <div
              ...
              className="absolute right-6 top-6 rounded-2xl border border-[var(--border-default)] bg-[var(--surface-card)]/90 px-4 py-2 text-sm shadow-[var(--shadow-card)] backdrop-blur-md"
            >
            ...
            <div className="absolute bottom-6 left-6 max-w-[210px] rounded-2xl border border-[var(--border-default)] bg-[var(--surface-card)]/90 px-5 py-3 text-xs shadow-[var(--shadow-card)] backdrop-blur">
          ...
          <div
            data-fake-marker="hero-badges"
            className="absolute -bottom-5 -left-3 flex items-center gap-4 rounded-3xl border border-[var(--border-default)] bg-[var(--surface-card)] px-5 py-4 shadow-[var(--shadow-card)] md:-left-5"
          >
            <div>
