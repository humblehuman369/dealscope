...
import { PRO_YEARLY_PER_MONTH, STARTER_VERDICTS_PER_MONTH } from '@/lib/claims'
    ...
    <div className="iq-landing">
      ...
      <div className="cta-wrap">
        ...
        <div className="cta-sub-simple">
          {`${STARTER_VERDICTS_PER_MONTH} free analyses per month · No credit card required · Pro from $${PRO_YEARLY_PER_MONTH}/mo`}
        </div>
      </div>
