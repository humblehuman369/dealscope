      ...
      <section className="hero hero-centered">
        ...
        <div className="hero-inputs">
          <div className="input-group">
            ...
            <input type="text" placeholder="Enter property address..." readOnly onClick={handleEnterAddress} />
            <button className="btn-analyze" onClick={handleEnterAddress}>Analyze</button>
          </div>
