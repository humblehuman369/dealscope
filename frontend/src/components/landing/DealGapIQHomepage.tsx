    ...
    >
        ...
        <div className="hero-columns">
          <div className="hero-text">
            ...
            <p className="hero-sub">
              ...
              <strong>
                DealGap<span className="accent-inline">IQ</span> answers the only question that
                matters to an investor: is this a good deal?
              </strong>
            </p>
          ...
          <div className="hero-visual">
            <picture>
              ...
              <img
                src={
                  theme === 'light'
                    ? '/images/phone-demo-hero-light.png'
                    : '/images/phone-demo-hero.png'
                }
      ...
      <section className="founder-separator">
        <div className="founder-separator-inner">
          ...
          <div className="founder-separator-text">
            ...
            <p className="founder-separator-bio">
              35 years in real estate data, founded Foreclosure.com,
              <br />
              built HomePath.com, HomeSteps.com and
              <br />
      ...
      <section className="prices">
        <div className="prices-inner">
          ...
          <p className="prices-sub">
            DealGapIQ shows what it&apos;s worth (Market Value), what it takes to break even (Income
            Value), and what you should pay to profit (Target Buy), plus exactly how far the asking
            price is from each.
          </p>
      ...
      <section className="paradigm">
        <div className="paradigm-inner">
          ...
          <p className="paradigm-sub">
            ...
            that property. DealGapIQ was built for a completely different person with a completely
            different question.
          </p>
          ...
          <div className="manifesto-inline">
            <p className="manifesto-quote">
              &ldquo;You&apos;re not asking <span className="em">do I love this kitchen?</span>
              <br />
          ...
          <div className="comp-layout">
            ...
            <div className="comp-content">
              ...
              <div className="comp-features">
                {[
                  {
                    title: 'Pick your own comps',
                    desc: 'Select from recent sales within your target radius. You control which properties inform the appraisal.',
                  },
                  {
                    title: 'See every adjustment',
                    desc: 'Size, bedrooms, bathrooms, age, lot — each adjustment is transparent and follows appraisal methodology.',
                  },
                  {
                    title: 'Know your confidence',
                    desc: 'A weighted similarity score tells you exactly how reliable the estimate is.',
                  },
                  {
                    title: 'Download a URAR-style report',
                    desc: 'Professional Form 1004 format — ready for partners, lenders, or your records.',
                  },
                ].map((item, i) => (
              ...
              <p className="comp-disclaimer">
                <strong>Not a licensed appraisal.</strong> An investor-grade comp analysis modeled
                after the industry standard — so you can price property with the same rigor the
                professionals use.
              </p>
            </div>
          </div>
      ...
      <section className="video-section">
        <div className="video-inner">
          <div className="video-container" onClick={!isVideoPlaying ? playVideo : undefined}>
            <video
              ref={videoRef}
              preload="metadata"
              playsInline
          ...
          <div className="scan-layout">
            ...
            <div className="scan-content">
              ...
              <p className="scan-body">
                With DealGapIQ, simply point your phone, tap once, and instantly capture the
                property. Behind the scenes, DealGapIQ analyzes value, cash flow potential, and deal
                viability in seconds — so you know if it&apos;s worth pursuing before anyone else
                does.
              </p>
              ...
              <p className="scan-closing">
                Opportunities don&apos;t wait until you get back to your desk.{' '}
                <strong>Now, neither does your analysis.</strong>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="founder-inner">
          ...
          <div className="founder-content">
            ...
            <div className="founder-quote">
              &ldquo;I spent 35 years in real estate data — building HomePath.com for Fannie Mae,
              ...
              built to think like an investor, not market like an agent.&rdquo;
            </div>
