  ...
  return (
    <section className="founder-section">
      ...
      <div className="sec-title" style={titleStyle}>
        {title ?? (
          <>
            From the founder of Foreclosure.com — institutional-grade intelligence, now in every
            investor&apos;s hands.
          </>
        )}
      </div>
      <div className="card-lg founder-card">
        ...
        <div className="founder-body">
          <div className="founder-bio">
            <p>
              Over two decades ago, Fannie Mae discovered that Brad&apos;s proprietary data platform
              knew more about their portfolio than their own internal infrastructure — and
              commissioned him to build <strong>HomePath.com</strong>. He went on to build{' '}
              <strong>HomeSteps.com</strong> for Freddie Mac, establishing a trusted technology
              partnership with both GSEs that has lasted 30+ years.
            </p>
            <p>
              <strong>
                DealGap<span className="brand-iq">IQ</span>
              </strong>{' '}
              takes that same institutional-grade analytical rigor — the kind previously available
              only to large institutions and government agencies — and puts it in the hands of every
              individual investor.
            </p>
          </div>
