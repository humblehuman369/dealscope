  ...
  return (
    <div className="landing-page">
          ...
          <div className="nav-actions">
            {isAuthenticated ? (
              ...
              <>
                ...
                <button onClick={() => openAuthModal('register')} className="btn btn-sm btn-glow">
                  Get Started
                </button>
              </>
            )}
          ...
          <div className="hero-grid">
            ...
            <div className="hero-text">
              ...
              <h1 className="font-display">
                Know Exactly What to Offer in
                <br />
                <span className="iq">60 Seconds</span>
              </h1>
              <p className="hero-subtitle">
                Point your phone at any property. Get the{' '}
                <span className="highlight">Breakeven</span>,{' '}
                <span className="highlight">Target Buy</span>, and{' '}
                <span className="highlight">Wholesale</span> Price instantly — plus analysis across
      ...
      <section id="priceiq" className="priceiq-section">
        <div className="container">
          <div className="priceiq-header">
            ...
            <h2 className="priceiq-title font-display">Stop Guessing What to Offer</h2>
            <p className="priceiq-subtitle">
              DealMaker<span className="iq">IQ</span> doesn&apos;t just tell you if it&apos;s a
              deal. It tells you exactly what to pay — and why.
            </p>
          </div>
          ...
          <div className="priceiq-card">
              ...
              {priceIQData.map((price, i) => (
                <div key={i} className={`price-card ${price.featured ? 'featured' : ''}`}>
                  ...
                  <p className="price-card-name font-display">
                    {price.name}
                    <span className={price.featured ? '' : 'iq-cyan'}>{price.suffix}</span>
                  </p>
                  <p className="price-card-value font-display">{price.value}</p>
                  <p className="price-card-desc">{price.description}</p>
                  <p className={`price-card-subtext ${i === 0 ? 'price-card-subtext-nowrap' : ''}`}>
                    {price.subtext}
                  </p>
            ...
            <div className="priceiq-difference">
              <p className="priceiq-difference-title font-display">The Difference That Matters</p>
              <p className="priceiq-difference-text">
                Most calculators tell you what your ROI <em>would be</em> at a given price.
                <br />
                DealMaker<span className="iq">IQ</span> tells you what price <em>to offer</em> to
                hit your target returns.
                <br />
      ...
      <section id="how-it-works" className="scaniq-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title font-display">Feed It Any Property</h2>
            <p className="section-subtitle">
              Scan a For Sale sign. Paste an address. Drop in an MLS link. DealMaker
              <span className="iq">IQ</span> doesn&apos;t care how you find deals — it analyzes them
              all.
            </p>
          </div>
      ...
      <section className="modeliq-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title font-display">Dial In Your Numbers. Get Your Prices.</h2>
            <p className="section-subtitle">
              Adjust the deal. Watch your Price<span className="iq">IQ</span> update in real time.
              This is how professionals model offers.
            </p>
          </div>
            ...
            <div className="modeliq-results">
              ...
              <div className="modeliq-results-grid">
                ...
                <div className="result-card featured">
                  ...
                  <p className="result-value font-display">
                    {formatCompactCurrency(sliderValues.askingPrice)}
                  </p>
                </div>
                <div className="result-card">
      ...
      <section className="verdictiq-section">
        <div className="container">
          <div className="section-header">
            <p className="section-label">Discovery Output</p>
            <h2 className="section-title font-display">Get a Discovery, Not a Spreadsheet</h2>
            <p className="section-subtitle">
              Discovery tells you what the numbers mean — based on where the asking price falls
              relative to your Price<span className="iq">IQ</span>.
            </p>
          </div>
      ...
      <section id="strategies" className="strategyiq-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title font-display">One Property. Six Opportunities.</h2>
            <p className="section-subtitle">
              Most investors analyze one strategy at a time. DealMaker<span className="iq">IQ</span>{' '}
              shows you all six — instantly.
            </p>
          </div>
          ...
          <div className="strategy-grid">
            {strategies.map((strategy) => (
              <div key={strategy.id} className="strategy-card">
                {strategy.badge && <span className="strategy-badge">{strategy.badge}</span>}
      ...
      <section id="founder" className="founder-section">
        <div className="container">
          <div className="founder-content-centered">
            <p className="founder-label">From the Pioneer Behind the Platforms You Already Use</p>
            <p className="founder-quote">
              &ldquo;I built <strong>HomePath.com</strong> for Fannie Mae and{' '}
              <strong>HomeSteps.com</strong> for Freddie Mac. Founded{' '}
              <strong>Foreclosure.com</strong> before data platforms existed and spent 35 years
              building the infrastructure institutions depend on.{' '}
              <span className="highlight">DealMakerIQ</span> puts that same intelligence in your
              hands.&rdquo;
            </p>
            ...
            <div className="founder-credentials-inline">
              {founderInfo.credentials.map((cred, i) => (
                <span key={i} className="founder-credential">
                  {cred}
                </span>
              ))}
            </div>
      ...
      <section className="features-section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title font-display">Everything You Need to Analyze Deals</h2>
          </div>
            ...
            {iqFeatures.map((feature, i) => (
              <div key={i} className="feature-card">
                ...
                <h3 className="feature-name font-display">
                  {feature.name}
                  {feature.hasIQ && <span className="iq">IQ</span>}
      ...
      <section className="cta-section">
        <div className="container cta-content">
          ...
          <p className="cta-tagline font-display">Point. Scan. Know.</p>
        </div>
      </section>
