...
export function IQIconBrain() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Sparkle */}
      <path d="M12 2v1" stroke="#0FA4E9" strokeWidth="2"/>
      <path d="M17 4l-.7.7" stroke="#0FA4E9" strokeWidth="2"/>
      <path d="M7 4l.7.7" stroke="#0FA4E9" strokeWidth="2"/>
    </svg>
  );
}
...
export function IQIconLightbulb() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10 22h4"/>
      {/* IQ spark */}
      <circle cx="12" cy="8" r="2" fill="#0FA4E9" stroke="none"/>
    </svg>
  );
}
...
export function IQIconRobot() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 2v4"/>
      <circle cx="12" cy="2" r="1" fill="#0FA4E9"/>
      {/* Eyes */}
      <circle cx="9" cy="13" r="1.5" fill="#0FA4E9"/>
      <circle cx="15" cy="13" r="1.5" fill="#0FA4E9"/>
      {/* Smile */}
      <path d="M9 17h6" stroke="#0FA4E9"/>
    </svg>
  );
}
...
export function IQIconTarget() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="12" cy="12" r="2" fill="#0FA4E9"/>
      {/* Crosshairs */}
      <path d="M12 2v4" stroke="#0FA4E9"/>
      <path d="M12 18v4" stroke="#0FA4E9"/>
      <path d="M2 12h4" stroke="#0FA4E9"/>
      <path d="M18 12h4" stroke="#0FA4E9"/>
    </svg>
  );
}
...
export function IQIconSparkles() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0FA4E9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3z" fill="#0FA4E9" fillOpacity="0.2"/>
...
export function IQIconChart() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Checkmark bubble */}
      <circle cx="19" cy="7" r="4" fill="#0FA4E9" stroke="none"/>
