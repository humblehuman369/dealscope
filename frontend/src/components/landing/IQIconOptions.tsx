...
export function IQIconBrain() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Sparkle */}
      <path d="M12 2v1" stroke="var(--accent-sky)" strokeWidth="2"/>
      <path d="M17 4l-.7.7" stroke="var(--accent-sky)" strokeWidth="2"/>
      <path d="M7 4l.7.7" stroke="var(--accent-sky)" strokeWidth="2"/>
    </svg>
  );
}
...
export function IQIconLightbulb() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10 22h4"/>
      {/* IQ spark */}
      <circle cx="12" cy="8" r="2" fill="var(--accent-sky)" stroke="none"/>
    </svg>
  );
}
...
export function IQIconRobot() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 2v4"/>
      <circle cx="12" cy="2" r="1" fill="var(--accent-sky)"/>
      {/* Eyes */}
      <circle cx="9" cy="13" r="1.5" fill="var(--accent-sky)"/>
      <circle cx="15" cy="13" r="1.5" fill="var(--accent-sky)"/>
      {/* Smile */}
      <path d="M9 17h6" stroke="var(--accent-sky)"/>
    </svg>
  );
}
...
export function IQIconTarget() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="12" cy="12" r="2" fill="var(--accent-sky)"/>
      {/* Crosshairs */}
      <path d="M12 2v4" stroke="var(--accent-sky)"/>
      <path d="M12 18v4" stroke="var(--accent-sky)"/>
      <path d="M2 12h4" stroke="var(--accent-sky)"/>
      <path d="M18 12h4" stroke="var(--accent-sky)"/>
    </svg>
  );
}
...
export function IQIconSparkles() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3z" fill="var(--accent-sky)" fillOpacity="0.2"/>
...
export function IQIconChart() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Checkmark bubble */}
      <circle cx="19" cy="7" r="4" fill="var(--accent-sky)" stroke="none"/>
