  ...
  return (
    <section className="sec">
      ...
      <div className="sec-title">
        Experienced Investors Pass on 90% of Deals in Minutes.
        <br />
        Now So Can You.
      </div>
      <div className="sec-sub">
        Most properties aren&apos;t worth your time. The Discovery screen tells you which ones are —
        so you only go deep when it matters.
      </div>
      <div className="funnel">
        ...
        <div className="funnel-step">
          ...
          <div className="funnel-desc">
            Deals that pass the screen get your full attention and deep analysis
          </div>
        </div>
        <div className="funnel-step">
      ...
      >
        Typical monthly workflow for active investors
      </div>
      <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
        <Link href="/register" className="cta-btn">
          Start Scanning Free &rarr;
        </Link>
        <div style={{ fontSize: '.78rem', color: 'var(--muted)', marginTop: '.75rem' }}>
