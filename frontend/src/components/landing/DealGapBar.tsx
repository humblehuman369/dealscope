...
function FullBar({ incomePct, dealGapPct, priceGapPct, className = '' }: InternalBarProps) {
  ...
  return (
    ...
    >
      ...
      <text x={220} y={68} textAnchor="middle" fill={TARGET_COLOR} fontSize={16} fontWeight={800} letterSpacing={2.5}>
        DEAL GAP
      </text>
      ...
      {/* THE BAR */}
      <rect x={10} y={100} width={480} height={20} rx={10} ry={10} fill="url(#dgb-bar-full)" stroke="#1E3A5F" strokeWidth={1} />
      <rect x={12} y={102} width={476} height={6} rx={3} ry={3} fill="white" opacity={0.08} />

      {/* DOTS */}
      <Dot cx={TARGET_X} cy={110} color={TARGET_COLOR} r={9} innerR={5} coreR={3} glowId="dgb-glow-full" />
      <Dot cx={INCOME_X} cy={110} color={INCOME_COLOR} r={9} innerR={5} coreR={3} glowId="dgb-glow-full" />
      <Dot cx={MARKET_X} cy={110} color={MARKET_COLOR} r={9} innerR={5} coreR={3} glowId="dgb-glow-full" />

      {/* TARGET / INCOME / MARKET labels */}
      <text x={TARGET_X} y={138} textAnchor="middle" fill={TARGET_COLOR} fontSize={11} fontWeight={700} letterSpacing={2}>
        TARGET
      </text>
      <text x={INCOME_X} y={138} textAnchor="middle" fill={INCOME_COLOR} fontSize={11} fontWeight={700} letterSpacing={2}>
        INCOME
      </text>
      <text x={MARKET_X} y={138} textAnchor="middle" fill={MARKET_COLOR} fontSize={11} fontWeight={700} letterSpacing={2}>
        MARKET
      </text>
      ...
      {showPriceGap && (
        <>
          <path
            ...
            opacity={0.85}
          />
          <text x={(priceGapBracketStartX + MARKET_X) / 2 - 32} y={186} textAnchor="middle" fill={INCOME_COLOR} fontSize={16} fontWeight={800} letterSpacing={2.5}>
            PRICE GAP
          </text>
          <text x={(priceGapBracketStartX + MARKET_X) / 2 + 40} y={186} textAnchor="start" fill={INCOME_COLOR} fontSize={16} fontWeight={800}>
...
function CompactBar({ incomePct, dealGapPct, priceGapPct, className = '' }: InternalBarProps) {
  ...
  return (
    ...
    >
      ...
      <text x={120} y={52} textAnchor="middle" fill={TARGET_COLOR} fontSize={12} fontWeight={800} letterSpacing={1.8}>
        DEAL GAP
      </text>
      ...
      <rect x={8} y={82} width={264} height={16} rx={8} ry={8} fill="url(#dgb-bar-compact)" stroke="#1E3A5F" strokeWidth={1} />
      <rect x={10} y={84} width={260} height={5} rx={2.5} ry={2.5} fill="white" opacity={0.08} />

      <Dot cx={TARGET_X} cy={90} color={TARGET_COLOR} r={7} innerR={3.5} coreR={2} glowId="dgb-glow-compact" />
      <Dot cx={INCOME_X} cy={90} color={INCOME_COLOR} r={7} innerR={3.5} coreR={2} glowId="dgb-glow-compact" />
      <Dot cx={MARKET_X} cy={90} color={MARKET_COLOR} r={7} innerR={3.5} coreR={2} glowId="dgb-glow-compact" />

      <text x={TARGET_X} y={113} textAnchor="middle" fill={TARGET_COLOR} fontSize={9} fontWeight={700} letterSpacing={1.5}>
        TARGET
      </text>
      <text x={INCOME_X} y={113} textAnchor="middle" fill={INCOME_COLOR} fontSize={9} fontWeight={700} letterSpacing={1.5}>
        INCOME
      </text>
      <text x={MARKET_X} y={113} textAnchor="middle" fill={MARKET_COLOR} fontSize={9} fontWeight={700} letterSpacing={1.5}>
        MARKET
      </text>
      ...
      {showPriceGap && (
        <>
          <path
            ...
            opacity={0.85}
          />
          <text x={(INCOME_X + MARKET_X) / 2 - 22} y={155} textAnchor="middle" fill={INCOME_COLOR} fontSize={12} fontWeight={800} letterSpacing={1.8}>
            PRICE GAP
          </text>
          <text x={(INCOME_X + MARKET_X) / 2 + 26} y={155} textAnchor="start" fill={INCOME_COLOR} fontSize={12} fontWeight={800}>
            {formatPct(priceGapPct)}
          </text>
        </>
      )}
