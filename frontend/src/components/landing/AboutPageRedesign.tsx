...
const BarChartIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="2" strokeLinecap="round">
...
const BoltIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
  </svg>
)

const HomeIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" /><polyline points="9 22 9 12 15 12 15 22" />
  </svg>
)

const SunIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="2" strokeLinecap="round">
...
const CheckIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--accent-sky)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="ap-container">
          <div className="metric-grid">
            <Reveal>
              ...
              <h2 className="section-title">What is the<br /><span style={{ color: 'var(--accent-sky)' }}>Deal Gap?</span></h2>
      ...
      <section style={{ padding: '120px 24px' }}>
        <div className="ap-container">
          <Reveal>
            ...
            <h2 className="section-title">Every address analyzed six ways — automatically.</h2>
            <p className="section-desc">
              No more one-size-fits-all analysis. DealGapIQ evaluates every property through six distinct investment lenses, each with a fully editable Excel worksheet you can download and make your own.
            </p>
          </Reveal>
          <Reveal>
            <div className="strategies-grid">
              {strategies.map((s, i) => {
                const Icon = s.Icon
                return (
                  <div className="strategy-pill" key={i}>
          ...
          <Reveal>
            <div className="founder-grid">
              <div className="founder-portrait">
                <img src="/images/brad-geisen-headshot.png" alt="Brad Geisen" />
              </div>
          ...
          <Reveal>
            <div className="pricing-grid">
              ...
              <div className="price-card pro">
                ...
                <div className="price">$29<span style={{ fontSize: 18, fontWeight: 400, color: 'var(--text-label)' }}>/mo</span></div>
