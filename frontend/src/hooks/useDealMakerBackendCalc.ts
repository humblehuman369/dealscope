...
function buildPayload(
  ...
  if (strategyType === 'str') {
    ...
    return {
      ...
      property_management_pct: s.strManagementRate || s.managementRate || 0.1,
      ...
      insurance_annual: s.annualInsurance ?? buyPrice * OPERATING_INSURANCE_PCT,
  ...
  if (strategyType === 'brrrr') {
    ...
    return {
      ...
      down_payment_pct: s.downPaymentPercent || 0.2,
      interest_rate: s.hardMoneyRate || s.interestRate || 0.1,
  ...
  if (strategyType === 'house_hack') {
    ...
    return {
      ...
      insurance_annual: s.annualInsurance ?? purchasePrice * OPERATING_INSURANCE_PCT,
      vacancy_rate: s.vacancyRate || 0.05,
      maintenance_pct: s.maintenanceRate || 0.05,
