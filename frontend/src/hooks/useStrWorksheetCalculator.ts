...
const defaultInputs: StrWorksheetInputs = {
  ...
  furnishing_budget: 20000,
  down_payment_pct: 0.25,
  interest_rate: 0.075,
  loan_term_years: 30,
  average_daily_rate: 280,
  occupancy_rate: 0.7,
  cleaning_fee_revenue: 150,
  avg_booking_length: 5,
  platform_fees_pct: 0.12,
  property_management_pct: 0.2,
  cleaning_cost_per_turn: 100,
  supplies_monthly: 250,
  utilities_monthly: 350,
  insurance_annual: 250 * 12,
...
export function useStrWorksheetCalculator(property: SavedProperty | null) {
  ...
  useEffect(() => {
    ...
    const insurance = data.insurance ?? defaultInputs.insurance_annual
