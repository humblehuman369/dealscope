...
export const BUY_PRICE_SLIDERS: SliderConfig[] = [
  {
    ...
    step: 5000,
    format: 'currency',
    sourceLabel: 'IQ Breakeven Analysis',
  },
  {
...
export const REHAB_VALUATION_SLIDERS: SliderConfig[] = [
  ...
  },
  {
    ...
    step: 10000,
    format: 'currency',
    sourceLabel: 'Sales comps analysis',
  },
]
...
export const INCOME_SLIDERS: SliderConfig[] = [
  {
    ...
    sourceLabel: 'Rental comps analysis',
  },
  {
    id: 'otherIncome',
    label: 'Other Income',
...
export const EXPENSES_SLIDERS: SliderConfig[] = [
  {
    ...
    step: 0.01,
    format: 'percentage',
    sourceLabel: 'Market-specific historical',
  },
  {
    id: 'maintenanceRate',
    label: 'Maintenance',
  ...
  },
  {
    ...
    max: 20000,
    step: 100,
    format: 'currencyPerYear',
    sourceLabel: 'County assessment',
  },
  {
    id: 'annualInsurance',
    label: 'Insurance',
    ...
    step: 100,
    format: 'currencyPerYear',
    sourceLabel: 'Global insurance % × property value',
    isEstimate: true,
  },
...
export const DEFAULT_DEAL_MAKER_STATE: DealMakerState = {
  // Tab 1: Buy Price
  buyPrice: 300000,
  downPaymentPercent: 0.2, // Matches FINANCING.down_payment_pct
  ...
  managementRate: 0.0, // Matches OPERATING.property_management_pct
...
export const STR_REHAB_VALUATION_SLIDERS: STRSliderConfig[] = [
  ...
  {
    id: 'furnitureSetupCost',
    label: 'Furniture & Setup',
    min: 0,
    max: 30000,
    step: 1000,
    format: 'currency',
    sourceLabel: 'STR furnishing estimate',
  },
]
...
export const STR_INCOME_SLIDERS: STRSliderConfig[] = [
  {
    ...
    step: 10,
    format: 'currency',
    sourceLabel: 'Market ADR analysis',
  },
  {
    id: 'occupancyRate',
    ...
    step: 0.01,
    format: 'percentage',
    sourceLabel: 'Market average',
  },
  {
    id: 'cleaningFeeRevenue',
    label: 'Cleaning Fee (Revenue)',
    min: 0,
    max: 300,
    step: 25,
    format: 'currency',
    sourceLabel: 'Per booking',
  },
  {
    id: 'avgLengthOfStayDays',
...
export const STR_EXPENSES_SLIDERS: STRSliderConfig[] = [
  {
    ...
    step: 0.01,
    format: 'percentage',
    sourceLabel: 'Airbnb host fee',
  },
  {
    id: 'strManagementRate',
    label: 'STR Management',
    min: 0,
    max: 0.25,
    step: 0.01,
    format: 'percentage',
    sourceLabel: 'STR manager rate',
  },
  {
...
export const DEFAULT_STR_DEAL_MAKER_STATE: STRDealMakerState = {
  ...
  strManagementRate: 0.1, // Matches STR.str_management_pct
 ...
 */
export function getDefaultStateForStrategy(
...
export const BRRRR_BUY_SLIDERS: BRRRRSliderConfig[] = [
  {
    ...
    step: 5000,
    format: 'currency',
    sourceLabel: 'Discounted from ARV',
  },
  {
    id: 'buyDiscountPct',
  ...
  },
  {
    ...
    step: 0.05,
    format: 'percentage',
    sourceLabel: 'Hard money typical',
  },
  {
    id: 'hardMoneyRate',
...
export const BRRRR_REHAB_SLIDERS: BRRRRSliderConfig[] = [
  {
    ...
    step: 5000,
    format: 'currency',
    sourceLabel: 'Contractor estimate',
  },
  {
    id: 'contingencyPct',
    label: 'Contingency',
  ...
  },
  {
    ...
    step: 1,
    format: 'months',
    sourceLabel: 'Rehab + stabilize',
  },
  {
    id: 'holdingCostsMonthly',
    label: 'Monthly Holding Costs',
    min: 0,
    max: 3000,
    step: 100,
    format: 'currencyPerMonth',
    sourceLabel: 'Taxes, ins, utilities',
  },
  {
    id: 'arv',
...
export const BRRRR_RENT_SLIDERS: BRRRRSliderConfig[] = [
  {
    id: 'postRehabMonthlyRent',
    label: 'Post-Rehab Rent',
    min: 500,
    max: 10000,
    step: 50,
    format: 'currencyPerMonth',
    sourceLabel: 'After improvements',
  },
  {
    id: 'vacancyRate',
    label: 'Vacancy Rate',
...
export const BRRRR_REFINANCE_SLIDERS: BRRRRSliderConfig[] = [
  {
    ...
    step: 0.05,
    format: 'percentage',
    sourceLabel: 'Conventional limit',
  },
  {
    ...
    step: 0.00125,
    format: 'percentage',
    sourceLabel: 'Conventional 30-yr',
  },
  {
    ...
    step: 5,
    format: 'years',
    sourceLabel: 'Standard terms',
  },
  {
    id: 'refinanceClosingCostsPct',
    label: 'Closing Costs',
    min: 0.01,
    max: 0.05,
    step: 0.005,
    format: 'percentage',
    sourceLabel: 'Refi costs',
  },
]
...
export const DEFAULT_BRRRR_DEAL_MAKER_STATE: BRRRRDealMakerState = {
  ...
  downPaymentPercent: 0.2, // Hard money typical
  ...
  // Phase 2: Rehab
  rehabBudget: 40000,
  contingencyPct: 0.1, // 10% contingency
  ...
  postRehabRentIncreasePct: 0.1, // Matches BRRRR.post_rehab_rent_increase_pct
 ...
 */
export function isBRRRRState(
  state: AnyDealMakerState | BRRRRDealMakerState,
): state is BRRRRDealMakerState {
  return (
    'refinanceLtv' in state && 'holdingPeriodMonths' in state && 'cashLeftInDeal' in state === false
  )
}
 ...
 */
export function isBRRRRMetrics(
  metrics: AnyDealMakerMetrics | BRRRRMetrics,
): metrics is BRRRRMetrics {
...
export const DEFAULT_FLIP_DEAL_MAKER_STATE: FlipDealMakerState = {
  ...
  purchaseDiscountPct: 0.2, // Matches FLIP.purchase_discount_pct
  closingCostsPercent: 0.03,

  // Phase 2: Financing
  financingType: 'hardMoney',
  hardMoneyLtv: 0.9, // Matches FLIP.hard_money_ltv
 ...
 */
export function isFlipState(
  state: AnyDealMakerState | BRRRRDealMakerState | FlipDealMakerState,
): state is FlipDealMakerState {
 ...
 */
export function isFlipMetrics(
  metrics: AnyDealMakerMetrics | BRRRRMetrics | FlipMetrics,
): metrics is FlipMetrics {
...
export const HOUSEHACK_BUY_SLIDERS: HouseHackSliderConfig[] = [
  {
    ...
    step: 10000,
    format: 'currency',
    sourceLabel: 'Multi-unit property',
  },
  {
    id: 'totalUnits',
    label: 'Total Units',
  ...
  },
  {
    ...
    step: 1,
    format: 'units',
    sourceLabel: 'Units you live in',
  },
  {
    id: 'ownerUnitMarketRent',
    label: 'Owner Unit Market Rent',
    min: 500,
    max: 5000,
    step: 50,
    format: 'currencyPerMonth',
    sourceLabel: 'For comparison',
  },
]
 ...
 */
export function isHouseHackState(
  state: AnyDealMakerState | BRRRRDealMakerState | FlipDealMakerState | HouseHackDealMakerState,
): state is HouseHackDealMakerState {
 ...
 */
export function isHouseHackMetrics(
  metrics: AnyDealMakerMetrics | BRRRRMetrics | FlipMetrics | HouseHackMetrics,
): metrics is HouseHackMetrics {
  return (
    'effectiveHousingCost' in metrics &&
    'housingOffsetPercent' in metrics &&
    'livesForFree' in metrics
  )
}
...
export const WHOLESALE_CONTRACT_SLIDERS: WholesaleSliderConfig[] = [
  {
    ...
    step: 5000,
    format: 'currency',
    sourceLabel: 'Negotiated with seller',
  },
  {
    id: 'earnestMoney',
    label: 'Earnest Money',
    ...
    step: 100,
    format: 'currency',
    sourceLabel: 'At risk if deal fails',
  },
  {
    ...
    step: 1,
    format: 'days',
    sourceLabel: 'Due diligence window',
  },
  {
    id: 'daysToClose',
    label: 'Days to Close',
...
export const WHOLESALE_ASSIGNMENT_SLIDERS: WholesaleSliderConfig[] = [
  {
    ...
    step: 1000,
    format: 'currency',
    sourceLabel: 'Your wholesale fee',
  },
  {
    id: 'marketingCosts',
  ...
  },
  {
    ...
    step: 100,
    format: 'currency',
    sourceLabel: 'Minimal for assignment',
  },
]
 ...
 */
export function isWholesaleState(
  state:
    | AnyDealMakerState
    | BRRRRDealMakerState
    | FlipDealMakerState
    | HouseHackDealMakerState
    | WholesaleDealMakerState,
): state is WholesaleDealMakerState {
  return (
 ...
 */
export function isWholesaleMetrics(
  metrics: AnyDealMakerMetrics | BRRRRMetrics | FlipMetrics | HouseHackMetrics | WholesaleMetrics,
): metrics is WholesaleMetrics {
