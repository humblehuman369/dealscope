...
export const semanticTokens = {
  ...
  text: {
    ...
    link: { dark: '#0EA5E9', light: '#0369A1' },
  },
  accent: {
    brandBlue: { dark: '#0465f2', light: '#0344A6' },
    sky: { dark: '#0EA5E9', light: '#0369A1' },
    skyLight: { dark: '#38bdf8', light: '#0284C7' },
    brandGradientFrom: { dark: '#0465f2', light: '#0344A6' },
    brandGradientTo: { dark: '#0EA5E9', light: '#0369A1' },
  },
  status: {
    positive: { dark: '#34d399', light: '#047857' },
    warning: { dark: '#fbbf24', light: '#B45309' },
    negative: { dark: '#f87171', light: '#B91C1C' },
  ...
  border: {
    ...
    focus: { dark: '#0EA5E9', light: '#0369A1' },
  },
  shadow: {
