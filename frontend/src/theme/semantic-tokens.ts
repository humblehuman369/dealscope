...
export const semanticTokens = {
  surface: {
    base: { dark: '#000000', light: '#f7f4ee' },
    section: { dark: '#060B14', light: '#ffffff' },
    card: { dark: '#000000', light: '#ffffff' },
    cardHover: { dark: '#0C1220', light: '#e8f3ef' },
    elevated: { dark: '#0C1220', light: '#e8f3ef' },
  ...
  text: {
    ...
    link: { dark: '#0FA4E9', light: '#1f8a70' },
  },
  accent: {
    brandBlue: { dark: '#0465f2', light: '#0465f2' },
    sky: { dark: '#0FA4E9', light: '#1f8a70' },
    skyLight: { dark: '#38bdf8', light: '#146c59' },
    brandGradientFrom: { dark: '#0465f2', light: '#1f8a70' },
    brandGradientTo: { dark: '#0FA4E9', light: '#146c59' },
  },
  status: {
    positive: { dark: '#34d399', light: '#1f8a70' },
  ...
  border: {
    ...
    focus: { dark: '#0FA4E9', light: '#1f8a70' },
  },
  shadow: {
    card: {
      dark: '0 0 20px rgba(15,164,233,0.15)',
      light: '0 1px 2px rgba(24, 32, 28, 0.04), 0 4px 12px rgba(31, 138, 112, 0.06)',
    },
    cardHover: {
      dark: '0 0 30px rgba(15,164,233,0.25)',
      light: '0 4px 16px rgba(24, 32, 28, 0.08), 0 2px 8px rgba(31, 138, 112, 0.1)',
    },
    dropdown: {
