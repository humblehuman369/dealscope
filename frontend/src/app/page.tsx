      ...
      <div className="fixed inset-0 bg-gray-900 flex items-center justify-center p-6">
        <div className="text-center max-w-md">
          ...
          <div className="relative w-24 h-24 mx-auto mb-6">
            <div className="absolute inset-0 rounded-full bg-[#0EA5E9]/20 animate-ping"></div>
            <div className="absolute inset-2 rounded-full bg-[#0EA5E9]/30 animate-pulse"></div>
            <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-[#0EA5E9] to-[#0EA5E9] flex items-center justify-center shadow-lg shadow-[#0EA5E9]/30">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full py-4 px-6 bg-gradient-to-r from-[#0EA5E9] to-gray-900 text-white rounded-xl font-bold text-lg hover:from-[#5dd8e8] hover:to-gray-800 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {isGettingLocation ? (
                <>
