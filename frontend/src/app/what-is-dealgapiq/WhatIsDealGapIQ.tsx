  ...
  <div style={dividerWrap}>
    <div
      style={{
        ...
        boxShadow:
          '0 0 8px rgba(15,164,233,0.5), 0 0 20px rgba(15,164,233,0.25), 0 0 50px rgba(15,164,233,0.08)',
      }}
    />
  </div>
)
  ...
  return (
    <div style={{ ...blackCard('lg', 20), overflow: 'hidden' }}>
      ...
      >
        <div>
          <div style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.25rem' }}>
            1847 Oakridge Drive, Tampa, FL 33612
          </div>
          <div style={{ fontSize: '0.8rem', color: t.textMuted }}>
            3 bed · 2 bath · 1,640 sqft · Built 2004
          </div>
        </div>
        <div>
          <div
            style={{
              ...mono(0.6, { color: t.textMuted, textAlign: 'right', marginBottom: '0.15rem' }),
            }}
          >
            List Price
          </div>
      ...
      <div style={{ padding: '2rem 2rem 1.75rem', borderBottom: `1px solid ${t.borderSubtle}` }}>
        <div
          style={{
            ...mono(0.6, { color: '#FFFFFF', letterSpacing: '0.15em', marginBottom: '1.5rem' }),
          }}
        >
          Your Price Spectrum
        </div>
        <div style={{ position: 'relative', marginBottom: '0.5rem' }}>
          ...
          <div
            style={{
              height: 10,
              borderRadius: 5,
              background: `linear-gradient(90deg, ${t.teal}, ${t.green} 55%, ${t.amber} 78%, ${t.coral})`,
              position: 'relative',
            }}
          >
            {[
              { left: '30%', color: t.teal },
              { left: '62%', color: t.green },
              { left: '97%', color: t.coral },
            ].map((m, i) => (
              <div
                key={i}
                style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.75rem' }}>
            {[
              ...
              <div key={p.name} style={{ textAlign: p.align, flex: 1 }}>
                ...
                <div style={{ ...mono(0.58, { color: t.textMuted, marginBottom: '0.15rem' }) }}>
                  {p.name}
                </div>
                <div style={{ fontSize: '0.75rem', fontWeight: 600, color: p.subColor }}>
                  {p.sub}
                </div>
              </div>
            ))}
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '0.82rem', color: t.textSecondary, lineHeight: 1.6 }}>
            The list price is{' '}
            <strong style={{ color: '#FFFFFF', fontWeight: 600 }}>$61K above</strong> your Target
            Buy. This is the negotiating distance — the discount you&apos;d need to make this deal
            hit your return target.
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ ...mono(0.58, { color: t.textMuted, marginBottom: '0.75rem' }) }}>
            ...
            {[true, true, true, false, false].map((f, i) => (
              <div
                ...
                style={{
                  ...
                  height: 12,
                  borderRadius: '50%',
                  background: f ? t.teal : 'rgba(255,255,255,0.1)',
                }}
              />
            ))}
          </div>
          <div
            style={{ fontSize: '0.9rem', fontWeight: 700, color: t.amber, marginBottom: '0.2rem' }}
          >
            Moderate
          </div>
          <div style={{ fontSize: '0.7rem', color: t.textMuted, lineHeight: 1.4 }}>
            15–20% discounts require skill
          </div>
        </div>
      </div>

      <div
        className="wii-demo-verdict-grid"
        style={{
          padding: '1.5rem 2rem',
          display: 'grid',
          gridTemplateColumns: '1.5fr 1fr',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.8rem', color: t.textMuted }}>
              Tight margins, but potential with negotiation.
            </div>
          </div>
        </div>
        <div style={{ textAlign: 'center' }}>
          <div style={{ ...mono(0.58, { color: t.textMuted, marginBottom: '0.5rem' }) }}>
            SELLER MOTIVATION
          </div>
          <div
            style={{ display: 'flex', gap: 5, justifyContent: 'center', marginBottom: '0.35rem' }}
          >
            {[true, true, true, false].map((f, i) => (
              <div
                ...
                style={{
                  ...
                  height: 10,
                  borderRadius: '50%',
                  background: f ? t.amber : 'rgba(255,255,255,0.1)',
                }}
              />
            ))}
          </div>
      ...
      <div
        className="wii-demo-metrics-grid"
        ...
        {[
          {
            ...
            title: 'Income Value',
            color: t.green,
            desc: 'The maximum price the rental income supports. Above it, you lose money. No other platform calculates this.',
          },
          {
            key: 'tb',
            title: 'Target Buy',
            color: t.teal,
            desc: 'The price that hits your desired return. Change your return target, loan terms, or expenses — it recalculates instantly.',
          },
          {
            key: 'dg',
            title: 'Deal Gap',
            color: t.coral,
            desc: 'The discount between the asking price and your Target Buy. The bigger the gap, the better the deal — but the harder the negotiation.',
          },
        ].map((m, i) => (
          <div
            key={m.key}
...
const numberCards = [
  {
    icon: 'IV',
    title: 'Income Value',
    desc: 'The maximum price the property can support before cash flow turns negative. Above this line, you lose money. This is the breakeven boundary no other platform calculates.',
    bg: 'rgba(52,211,153,0.1)',
    bd: 'rgba(52,211,153,0.15)',
    color: t.green,
  },
  {
    icon: 'TB',
    title: 'Target Buy',
    desc: 'The price that delivers your desired return. Change your return target, loan terms, or expenses — it recalculates instantly. This is your number.',
    bg: 'rgba(15,164,233,0.1)',
    bd: 'rgba(15,164,233,0.15)',
    color: t.teal,
  },
  {
    icon: 'DG',
    title: 'Deal Gap',
    desc: 'The distance between the asking price and your Target Buy. The built-in profit opportunity and your negotiation distance. The bigger the gap, the better the deal.',
    bg: 'rgba(249,112,102,0.1)',
    bd: 'rgba(249,112,102,0.15)',
    color: t.coral,
  },
]
...
const workflowSteps = [
  ...
  },
  {
    ...
    desc: 'Lender-ready PDFs, side-by-side comparisons, and a full pipeline from first look to closing.',
  },
]
...
const WorkflowStep = ({ num, label, title, desc }: (typeof workflowSteps)[0]) => (
  ...
  >
    ...
    <h3 style={{ fontSize: '1rem', fontWeight: 600, marginBottom: '0.5rem', color: t.textPrimary }}>
      {title}
    </h3>
...
const CredItem = ({ text, highlight = false }: { text: string; highlight?: boolean }) => (
  <div
    style={{
      ...
      border: `1px solid ${highlight ? 'rgba(15,164,233,0.25)' : 'rgba(255,255,255,0.08)'}`,
      borderRadius: 10,
      fontSize: '0.85rem',
      color: highlight ? t.teal : t.textSecondary,
      fontWeight: 500,
    }}
  >
    <span
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="wii-nav-links"
          style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}
        >
          <Link
            href="/what-is-dealgapiq"
            style={{
              color: t.textPrimary,
              textDecoration: 'none',
              fontSize: '0.875rem',
      ...
      {/* HERO */}
      <header
        style={{ padding: '10rem 2rem 6rem', maxWidth: 900, margin: '0 auto', textAlign: 'center' }}
      >
        <div
          style={{
            ...monoLabel,
        ...
        >
          ...
          <br />
          <em style={{ fontStyle: 'normal', color: t.teal }}>
            &ldquo;Is this actually a deal?&rdquo;
          </em>
        </h1>
        <p
          style={{
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', marginTop: '3rem' }}>
          <div
            style={{ fontSize: '1.05rem', color: t.textSecondary, lineHeight: 1.85, maxWidth: 720 }}
          >
            <p>
              At the core of DealGapIQ is a proprietary concept:{' '}
              <strong style={{ color: t.textPrimary, fontWeight: 600 }}>the Deal Gap</strong> — the
              distance between the asking price and the price required to hit your target return.
            </p>
            <p style={{ marginTop: '1.25rem' }}>
              That single number tells you whether the deal is worth pursuing, how much to
              negotiate, and how hard the negotiation will be.
            </p>
            <p style={{ marginTop: '1.25rem' }}>
              This turns real estate from a search game into a{' '}
              <strong style={{ color: t.textPrimary, fontWeight: 600 }}>decision system</strong>.
              Most investors search the same listings, use the same filters, and compete on speed.
              DealGapIQ analyzes every property to find the ones that actually are deals — by
      ...
      <section style={sectionWrap}>
        ...
        <div style={sectionSubtitle}>
          ...
          In seconds, you know where you break even, where you profit, and whether the deal is
          realistic.
        </div>
        <div className="wii-grid-3col" style={{ marginTop: '3rem' }}>
          {numberCards.map((n) => (
            <NumberCard key={n.icon} {...n} />
          ))}
        </div>
      </section>
      ...
      <section style={sectionWrap}>
        ...
        <div style={sectionSubtitle}>
          When a deal passes your screen, everything you need to act is already done.
        </div>
      ...
      <section style={{ padding: '6rem 2rem', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '3rem', ...blackCard('lg', 24), overflow: 'hidden' }}>
          <div
            style={{
              height: 3,
              background: `linear-gradient(90deg, ${t.teal}, ${t.teal} 60%, transparent)`,
            }}
          />
          <div
            className="wii-founder-header"
            style={{
              display: 'flex',
              alignItems: 'center',
              gap: '1.75rem',
          ...
          <div className="wii-founder-body">
            <div style={{ fontSize: '0.95rem', color: t.textSecondary, lineHeight: 1.85 }}>
              <p>
                Over two decades ago, Fannie Mae discovered that Brad&apos;s proprietary data
                platform knew more about their portfolio than their own internal infrastructure —
                and commissioned him to build HomePath.com. He went on to build HomeSteps.com for
                Freddie Mac, establishing a trusted technology partnership with both GSEs.
              </p>
              <p style={{ marginTop: '1.25rem' }}>
                DealGapIQ takes institutional-grade analytical rigor — the kind previously available
                only to large institutions and government agencies — and puts it in the hands of
      ...
      <section style={sectionWrap}>
        ...
        <div style={sectionTitle}>
          Most investors analyze deals.
          <br />
          Professional investors eliminate bad deals fast.
        </div>
        <div style={{ ...sectionSubtitle, marginBottom: '2.5rem' }}>
          ...
          your criteria, and make confident offers backed by real numbers. Less time underwriting.
          Fewer bad purchases. Faster portfolio growth. Stronger negotiations.
        </div>
      </section>
