    ...
    <div className="min-h-screen bg-[#e8eef3]" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            {isAuthenticated && user ? (
              <>
                <button
                  ...
                  className="px-6 py-3 bg-[#0465f2] text-white font-bold rounded-lg hover:bg-[#0354d1] transition-all flex items-center gap-2"
                >
                ...
                <button
                  onClick={logout}
                  className="px-6 py-3 bg-transparent text-[#07172e] font-bold rounded-lg hover:bg-black/5 transition-all"
                >
                  Sign Out
                </button>
              </>
              ...
              <>
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[#0465f2] text-white font-bold rounded-lg hover:bg-[#0354d1] transition-all"
                >
                  Get Started
                </button>
              </>
      ...
      <div className="bg-gradient-to-r from-[#0465f2] to-[#00e5ff] py-16 text-center text-white mb-12">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6">
            <Home className="w-12 h-12 text-[#0465f2]" />
          </div>
          <h1 className="text-5xl font-extrabold">Long-Term Rental</h1>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-8 pb-16">
        <div className="bg-white rounded-3xl p-12 shadow-lg mb-8">
          <h2 className="text-3xl font-bold text-[#07172e] mb-6">The Classic Buy-and-Hold Strategy</h2>
          ...
          <div className="bg-gradient-to-r from-[#e0f2fe] to-[#dbeafe] border-l-4 border-[#0465f2] rounded-lg p-6 my-8">
            <h3 className="text-2xl font-bold text-[#07172e] mb-4">The magic happens in three ways:</h3>
            <ol className="space-y-4">
              <li className="flex items-start gap-4">
                <span className="w-8 h-8 bg-[#0465f2] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">1</span>
                <div>
                  <strong className="text-[#07172e]">Monthly cash flow</strong>
                  <span className="text-[#4a5568]"> puts money in your pocket NOW!</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="w-8 h-8 bg-[#0465f2] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">2</span>
                <div>
                  <strong className="text-[#07172e]">Your tenants build equity for you</strong>
                  <span className="text-[#4a5568]"> by paying down the loan</span>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="w-8 h-8 bg-[#0465f2] text-white rounded-full flex items-center justify-center font-bold flex-shrink-0">3</span>
                <div>
                  <strong className="text-[#07172e]">Appreciation</strong>
          ...
          <div className="bg-gradient-to-r from-[#cffafe] to-[#e0f2fe] border-l-4 border-[#00e5ff] rounded-lg p-6 my-8">
            <p className="text-lg text-[#07172e] italic">
          ...
          <button
            onClick={() => router.push('/landing2')}
            className="w-full py-5 bg-gradient-to-r from-[#0465f2] to-[#00e5ff] text-white text-xl font-bold rounded-full hover:-translate-y-0.5 transition-transform"
          >
            Got it!
          </button>
        </div>
        ...
        <div className="bg-white rounded-3xl p-12 shadow-lg">
          <h2 className="text-3xl font-bold text-[#07172e] mb-8">Why Choose Long-Term Rental?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              <div className="text-5xl mb-4">💰</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">Steady Income</h4>
              <p className="text-[#4a5568]">Predictable monthly cash flow</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">📈</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">Wealth Building</h4>
              <p className="text-[#4a5568]">Equity growth over time</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">🏠</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">Tax Benefits</h4>
