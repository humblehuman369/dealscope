    ...
    <div className="min-h-screen bg-[#e8eef3]" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="bg-gradient-to-r from-[#0465f2] to-[#00e5ff] py-16 text-center text-white mb-12">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center mx-auto mb-6">
            <BarChart3 className="w-12 h-12 text-[#0465f2]" />
          </div>
          <h1 className="text-5xl font-extrabold">Fix & Flip</h1>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-8 pb-16">
        <div className="bg-white rounded-3xl p-12 shadow-lg mb-8">
          <h2 className="text-3xl font-bold text-[#07172e] mb-6">The Fast-Cash Strategy</h2>
          ...
          <div className="bg-gradient-to-r from-[#e0f2fe] to-[#dbeafe] border-l-4 border-[#0465f2] rounded-lg p-6 my-8">
            <h3 className="text-2xl font-bold text-[#07172e] mb-4">Profit Potential</h3>
            <p className="text-lg text-[#07172e]">A successful flip can net you <strong>$30,000–$100,000+ in profit!</strong></p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-12 shadow-lg">
          <h2 className="text-3xl font-bold text-[#07172e] mb-8">Why Choose Fix & Flip?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              <div className="text-5xl mb-4">⚡</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">Quick Returns</h4>
              <p className="text-[#4a5568]">See profits in 3-6 months</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">💰</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">High Profit</h4>
              <p className="text-[#4a5568]">$30K-$100K+ per deal</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">🔨</div>
              <h4 className="text-xl font-bold text-[#07172e] mb-2">Value Creation</h4>
