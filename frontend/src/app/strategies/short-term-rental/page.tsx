    ...
    <div className="min-h-screen bg-[#e8eef3]" style={{ fontFamily: 'Poppins, sans-serif' }}>
      ...
      <div className="bg-brand-500 py-8 text-white mb-12">
        <div className="max-w-[1280px] mx-auto px-8 flex items-center justify-center gap-6">
          ...
          <h1 className="text-4xl font-extrabold">Short-Term Rental</h1>
        </div>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-8 pb-16">
        <div className="bg-white rounded-3xl p-12 shadow-lg mb-8">
          <h2 className="text-3xl font-bold text-navy-900 mb-6">The High-Revenue Hospitality Model</h2>
          ...
          <div className="bg-gradient-to-r from-[#e0f2fe] to-[#dbeafe] border-l-4 border-brand-500 rounded-lg p-6 my-8">
            <h3 className="text-2xl font-bold text-navy-900 mb-4">The best part?</h3>
            <p className="text-lg text-navy-900">You can block off dates to use the property yourself for vacation!</p>
          </div>
        ...
        <div className="bg-white rounded-3xl p-12 shadow-lg">
          <h2 className="text-3xl font-bold text-navy-900 mb-8">Why Choose Short-Term Rental?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8">
              <div className="text-5xl mb-4">💵</div>
              <h4 className="text-xl font-bold text-navy-900 mb-2">Higher Revenue</h4>
              <p className="text-[#4a5568]">2-3x more than long-term rentals</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">📅</div>
              <h4 className="text-xl font-bold text-navy-900 mb-2">Flexibility</h4>
              <p className="text-[#4a5568]">Block dates for personal use</p>
            </div>
            <div className="text-center p-8">
              <div className="text-5xl mb-4">🌴</div>
              <h4 className="text-xl font-bold text-navy-900 mb-2">Tourism Markets</h4>
