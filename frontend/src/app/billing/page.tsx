...
function getPlans(isAnnual: boolean): PlanConfig[] {
  return [
    ...
    },
    {
      ...
      price: '$0',
      period: '/month',
      note: 'Free forever · 10 analyses/month',
      features: [
        { text: '10 property analyses per month', available: true },
        { text: 'Deal Gap + Income Value + Target Buy', available: true },
        { text: 'Discovery score (Pass / Marginal / Buy)', available: true },
        { text: '6 strategy snapshots', available: true },
        { text: 'Seller Motivation indicator', available: true },
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "On Starter, no — your 10 analyses reset monthly. On Pro, there's no limit so it doesn't matter.",
  },
]
        ...
        <div className="max-w-[960px] mx-auto px-5 md:px-8 pt-8 md:pt-12 pb-12 md:pb-16">
          ...
          {message && (
            <div className="mb-8">
              <div
                ...
                style={{
                  background:
                    message.type === 'success' ? 'rgba(52,211,153,0.08)' : 'rgba(249,112,102,0.08)',
                  border: `1px solid ${
                    message.type === 'success' ? 'rgba(52,211,153,0.25)' : 'rgba(249,112,102,0.25)'
                  }`,
          ...
          >
            ...
            <div style={{ fontSize: '1rem', lineHeight: 1.75 }}>
              ...
              <strong style={{ color: T.teal, fontWeight: 700 }}>$15,000–$40,000</strong> per
              property. Pro pays for itself on the first deal you walk away from.
            </div>
          </div>
          ...
          <div className="text-center" style={{ marginBottom: '3rem' }}>
            ...
            >
              Stop Screening Blind.
              <br />
              See the Full Picture.
            </h2>
            <p className="mx-auto" style={{ fontSize: '1rem', color: T.muted, maxWidth: 540 }}>
              Starter shows you the three numbers. Pro shows you <em>why</em> they are what they are
              — and lets you change every assumption until you&apos;re confident enough to make an
              offer.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{ marginBottom: '3rem' }}>
            {PLANS.map((plan) => {
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: 'var(--surface-card)',
                    border: `1px solid ${
                      isPlanPro ? (proHovered ? T.proBorderHover : T.proBorder) : T.border
                    }`,
                    boxShadow: isPlanPro
                      ? proHovered
                        ? T.proGlowHover
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: '0.85rem', color: T.muted }}>{plan.period}</span>
                  </div>
                  ...
                  {/* Feature list */}
                  <div className="flex flex-col" style={{ gap: '0.7rem', marginBottom: '2rem' }}>
          ...
          >
            {(IS_CAPACITOR ? TRUST_ITEMS_CAPACITOR : TRUST_ITEMS_WEB).map(({ Icon, text }) => (
              ...
              >
                <Icon className="flex-shrink-0" style={{ width: 16, height: 16, color: T.green }} />
                <span>{text}</span>
              </div>
            ))}
          </div>
          ...
          {/* ── Privacy & Terms ── */}
          <div className="flex items-center justify-center gap-3" style={{ padding: '2rem 0 0' }}>
            <a
          ...
          {IS_CAPACITOR && (
            ...
            >
              ...
              24&nbsp;hours prior to the end of the current period at the same price. You can manage
