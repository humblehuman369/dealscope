      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-navy-800 rounded-2xl shadow-lg border border-slate-200 dark:border-navy-700 p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={reset}
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#0FA4E9] hover:bg-[#0284c7] text-white font-medium rounded-lg transition-colors"
            >
          ...
          <button
            ...
            className="mt-6 inline-flex items-center gap-1 text-sm text-slate-500 dark:text-slate-400 hover:text-[#0FA4E9] dark:hover:text-[#38BDF8] transition-colors"
          >
