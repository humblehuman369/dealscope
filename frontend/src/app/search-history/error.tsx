...
// ===========================================
// Search History Error — Dark Fintech Theme
// ===========================================
...
export default function SearchHistoryError({ error, reset }: ErrorProps) {
  useEffect(() => {
      ...
      <div className="max-w-md w-full">
        <div className="bg-[#0C1220] rounded-2xl border border-white/[0.07] p-8 text-center">
          ...
          <p className="text-slate-400 mb-6">
            We couldn&apos;t load your search history. Your saved data is not affected.
          </p>
