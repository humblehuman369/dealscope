...
async function getPropertyData(zpid: string, address?: string): Promise<PropertyData | null> {
  ...
  console.log('[Property Details Page] Using Backend URL:', BACKEND_URL)
  ...
  try {
    ...
    // Photos are fetched client-side after render (non-blocking) — see PropertyPhotoGallery
    const normalized = normalizePropertyData(propertyData, null, zpid)
