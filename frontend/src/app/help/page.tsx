...
const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Yes. DealGapIQ is currently in free beta. All features — including unlimited analyses, PDF reports, and portfolio tracking — are free during the beta period. We\'ll announce paid tiers before they launch, and beta users will get early-access pricing.',
  },
  // Analysis & Scoring
  {
  ...
  },
  {
    ...
    answer: 'DealGapIQ pulls from multiple data sources including public property records, MLS listings, tax assessor data, rental market comps, short-term rental platforms, and comparable sales. We combine these sources to give you the most accurate picture possible.',
  },
  {
    category: 'Analysis & Scoring',
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-400">
            ...
            <a href="mailto:support@dealgapiq.com" className="text-sky-400 hover:text-sky-300 underline">Contact support</a>.
          </p>
        </div>
