    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-8 px-4 sm:px-6 lg:px-8 transition-colors">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Manage your account settings and investment preferences</p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between -mt-12 sm:-mt-16">
              <div className="flex items-end gap-4">
                ...
                <div className="relative">
                  <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-2xl bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center text-white text-4xl sm:text-5xl font-bold border-4 border-white dark:border-slate-800 shadow-lg">
                ...
                <div className="mb-2">
                  {isEditing ? (
                    <input
                      ...
                      className="text-2xl font-bold bg-transparent border-b-2 border-teal-500 text-gray-900 dark:text-white focus:outline-none"
                      placeholder="Your name"
                    />
                  ) : (
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{user?.full_name || 'Add your name'}</h2>
                  )}
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 hover:border-teal-500 dark:hover:border-teal-500 transition-colors text-left">
            <Bell className="w-6 h-6 text-teal-500 mb-2" />
            <p className="font-medium text-gray-900 dark:text-white">Notifications</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Manage alerts & emails</p>
          </button>
          
          <button className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 hover:border-teal-500 dark:hover:border-teal-500 transition-colors text-left">
            <Palette className="w-6 h-6 text-teal-500 mb-2" />
            <p className="font-medium text-gray-900 dark:text-white">Appearance</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Theme & display settings</p>
          </button>
