...
export const STRATEGIES: StrategyItem[] = [
  {
    ...
    desc: 'Buy and hold for monthly cash flow',
    icon: Home,
    color: 'bg-blue-500',
  },
  {
    ...
    desc: 'Airbnb/VRBO vacation rentals',
    icon: Building2,
    color: 'bg-purple-500',
  },
  {
  ...
  },
  {
    id: 'flip',
    label: 'Fix & Flip',
    desc: 'Renovate and sell for profit',
    icon: Zap,
    color: 'bg-pink-500',
  },
  {
    id: 'house_hack',
    label: 'House Hack',
    desc: 'Live in one unit, rent the others',
    icon: Home,
    color: 'bg-green-500',
  },
  {
    id: 'wholesale',
    label: 'Wholesale',
    desc: 'Assign contracts for assignment fees',
    icon: Briefcase,
    color: 'bg-cyan-500',
  },
]
...
export const EXPERIENCE_LEVELS = [
  ...
  { value: 'intermediate', label: 'Some Experience', desc: '1-5 deals completed', icon: '📈' },
  {
    ...
    desc: '5-20 deals under your belt',
    icon: '🎯',
  },
  {
    value: 'expert',
    label: 'Expert / Full-Time',
    desc: '20+ deals, investing is your business',
    icon: '🏆',
  },
] as const
...
export const RISK_LEVELS = [
  {
    value: 'conservative',
    label: 'Conservative',
    desc: 'Stable returns, lower risk',
...
export const DOWN_PAYMENT_OPTIONS: DownPaymentOption[] = [
  ...
  { value: 0.1, label: '10%', desc: 'Hard money typical' },
  { value: 0.2, label: '20%', desc: 'Conventional, no PMI' },
