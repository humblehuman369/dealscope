...
function StrategyContent() {
  ...
  useEffect(() => {
    ...
    router.replace(`/app/strategy?${nextParams.toString()}`, { scroll: false })
  ...
  const handleBack = useCallback(() => {
    router.push(`/app/verdict?address=${encodeURIComponent(resolvedAddress)}`)
