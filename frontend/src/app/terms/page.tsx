      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p>
              DealGapIQ provides real estate investment analytics tools, including property analysis
              across multiple investment strategies, deal scoring, price target calculations, and
              related features. The Service is available via web application and mobile application.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-semibold text-amber-400/90">
              DealGapIQ is an analytics tool, not a financial advisor, lender, or real estate
              broker. The information provided by the Service is for informational and educational
              purposes only and does not constitute financial, investment, legal, or tax advice.
            </p>
            <p className="mt-3">
              You should consult qualified professionals before making any investment decisions. We
              make no guarantees about the accuracy, completeness, or timeliness of any data,
              calculations, or recommendations provided by the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              DealGapIQ aggregates data from third-party sources including public records, MLS
              feeds, and proprietary APIs. While we strive for accuracy, data may be incomplete,
              delayed, or contain errors. Property values, rental estimates, and market conditions
              are approximations and should not be relied upon as the sole basis for investment
              decisions.
            </p>
          </section>
