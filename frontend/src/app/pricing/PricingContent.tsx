...
const COMPARISON_DATA: ComparisonCategory[] = [
  {
    ...
    rows: [
      ...
      {
        name: 'Multi-source IQ Estimates (Zillow, RentCast, Redfin, Realtor)',
        free: true,
        pro: true,
      },
      { name: 'Choose your preferred estimate source', free: true, pro: true },
      {
        name: 'All 6 strategy snapshots (LTR, STR, BRRRR, Flip, House Hack, Wholesale)',
        free: true,
        pro: true,
      },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Your analyzed properties are never shared, sold, or used to front-run your offers.
              Your deal flow is yours alone.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          Every DealGapIQ calculation is built on real data: comparables, rents, local vacancy
          rates, taxes, and market-specific assumptions. Pro lets you see every input, challenge
          every assumption, and stress test the deal before you write the offer.
        </p>
      ...
      >
        ...
        >
          &ldquo;In the early 1990&apos;s, while running a foreclosure disposition pilot program for
          HUD, I started building a proprietary data system that gave investors more insight than
          their intuition, that system was later known as Foreclosure.com. Exceeding the
          institutional platforms, I was commissioned to build HomePath.com for Fannie Mae and
          HomeSteps.com for Freddie Mac. DealGapIQ takes that same institutional-grade intelligence
          to the next level, putting it in your hands.&rdquo;
        </p>
      ...
      <div style={{ maxWidth: '640px', margin: '80px auto 0' }}>
        <h2
          style={{ fontSize: '24px', fontWeight: 700, margin: '0 0 32px 0', textAlign: 'center' }}
        >
          Common questions
        </h2>
        {faqs.map((faq, i) => (
      ...
      >
        ...
        <div
          className="pricing-bottom-options"
          style={{
            display: 'flex',
            gap: '12px',
            justifyContent: 'center',
        ...
        >
          <div
            className="pricing-bottom-option"
        ...
        {IS_CAPACITOR &&
          (() => {
            ...
            return (
              ...
              >
                After your 7-day free trial, your {accountName} account will be charged at the rate
                shown above. Subscription automatically renews at the same price unless canceled
                {cancelWindow} the end of the current period. Manage or cancel anytime in your{' '}
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <Link
            href="/privacy"
            style={{ fontSize: '11px', color: 'var(--text-label)', textDecoration: 'none' }}
          >
            Privacy
          </Link>
          <Link
