export const BLOG_INDEX_DESCRIPTION =
  'Real estate investment analysis, creative-finance teardowns, deal structures, and the pitch scripts that close the deal. Built for active investors who know the price tag is not the deal — the structure is.'
