 ...
 * Action plan (`components/deal/ActionPlanSlideOver.tsx`):
 *   `action_plan_run`            {case, model, searches, cost} — metered research finished.
 *                                Cache hits do not fire. Also captured server-side.
