...
export const INDEXABLE_SITE_SECTIONS = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/blog/category/creative-finance', label: 'Blog: Creative finance' },
      { href: '/blog/category/deal-analysis', label: 'Blog: Deal analysis' },
      { href: '/blog/category/offers-negotiation', label: 'Blog: Offers & negotiation' },
      { href: '/blog/category/financing', label: 'Blog: Financing' },
      { href: '/blog/category/strategies', label: 'Blog: Strategies' },
      { href: '/blog/category/markets', label: 'Blog: Markets' },
      { href: '/markets', label: 'Investor market data by state' },
