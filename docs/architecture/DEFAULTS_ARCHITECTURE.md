...
Discovery “Three Paths” runs a small set of deal-structure templates (price negotiation, seller second, rent uplift, subject-to heuristic, rate buydown, larger down, etc.). Which templates are eligible is controlled by booleans merged from:
...
- Click navigates to full Discovery page
