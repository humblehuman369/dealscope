---
title: "The Lake Worth Teardown: One Property, Four Ways to Close It"
slug: lake-worth-teardown-four-offer-structures
type: blog
intent: Founder POV / Wedge
primary_keyword: how to make offer below asking
secondary_keywords:
  - real estate deal analysis example
...
I ran 1014 N J St, Lake Worth Beach, FL through the verdict yesterday. 3 bed, 2.5 bath, 1,568 sqft. Currently off-market — but the kind of property I want to be ready to move on if it comes back.
...
A traditional buyer's calculator returns one verdict here: *no.*
...
The verdict pulled rent at $3,250 — IQ Estimate. RentCast pulled $3,500. Mashvisor pulled $3,000. The spread tells me the rent comp is debatable. If a 3-comp manual check supports $3,399, that's a +4.6% lift over the verdict's anchor and it closes $140/month of the cash-flow gap.
...
This is a [seller carryback](/glossary/seller-carryback), not a [Subject-To](/glossary/subject-to-financing). The seller isn't keeping their existing loan; they're *creating* a new small loan to you. Easier to pitch than Sub2 because it doesn't require the seller to leave their name on a mortgage. Same effect on the math.
...
- **Path 1** closes if the comp check tells me the rent is higher than the verdict assumed. Cheapest path, run first.
...
The full annotated script template — including how to handle the three seller types you'll meet — is at [The Subject-To Pitch Script: A Template That Reframes Price as Terms](/blog/subject-to-pitch-script-template).

The structure on this property uses a [seller carryback](/glossary/seller-carryback), not a [Subject-To](/glossary/subject-to-financing). The pitch logic is the same: lead with what they keep, translate the structure into seller-language, anchor on full asking, name the trade.
...
That's why the verdict isn't a recommendation. It's a surfacing tool. The four paths are the structures the math says could close this gap; which one actually closes is a function of the seller, the market, and the investor's own capital and risk position. *We analyze. You decide.*

The point is that the verdict didn't end at *"no."* It returned four ways to make the property pencil — and the script for each one. That's the layer that's missing from every other tool I've used in 18 years of real-estate investing.

## Run yours

Paste a Zillow URL or street address. In 15 seconds you'll see the verdict and the four paths. If the math works, you'll know. If it needs structure, you'll see exactly which structures fit.
